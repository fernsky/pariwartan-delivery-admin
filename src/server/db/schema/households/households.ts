...
export const households = pgTable("acme_pariwartan_households", {
...
export const stagingHouseholds = pgTable("staging_acme_pariwartan_household", {
...
export const householdEditRequests = pgTable("acme_pariwartan_household_edit_requests", {
