...
export const municipalityWideAgricultureRepresentatives = pgTable("municipality_wide_agriculture_representatives", {
  ...
  positionFull: varchar("position_full", { length: 255 }).notNull(),
