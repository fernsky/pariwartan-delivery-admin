...
DO $$
BEGIN
    IF (SELECT COUNT(*) FROM acme_Paribartan_household) = 0 THEN
        -- Insert dummy households data
        INSERT INTO acme_Paribartan_household (
        ...
        -- Ward 1
        ('household_001', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 1, 
         'KH-W1-001', 'KH-F-001', '2023-09-15',
         ARRAY[81.6712, 28.1346], 'परिवर्तन केन्द्र', 'रामेश्वर पौडेल',
        ...
        ('household_002', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 1, 
         'KH-W1-002', 'KH-F-002', '2023-09-16',
         ARRAY[81.6734, 28.1367], 'परिवर्तन केन्द्र', 'सरिता थापा',
        ...
        ('household_003', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 1, 
         'KH-W1-003', 'KH-F-003', '2023-09-17',
         ARRAY[81.6756, 28.1378], 'पूर्वी परिवर्तन', 'नवराज शर्मा',
        ...
        -- Ward 2
        ('household_004', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 2, 
         'KH-W2-001', 'KH-F-004', '2023-09-18',
         ARRAY[81.6825, 28.1412], 'पश्चिम परिवर्तन', 'विनोद कुमार खत्री',
        ...
        ('household_005', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 2, 
         'KH-W2-002', 'KH-F-005', '2023-09-19',
         ARRAY[81.6847, 28.1423], 'पश्चिम परिवर्तन', 'कमला देवी श्रेष्ठ',
        ...
        -- Ward 3
        ('household_006', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 3, 
         'KH-W3-001', 'KH-F-006', '2023-09-20',
         ARRAY[81.6912, 28.1489], 'उत्तर परिवर्तन', 'प्रकाश बहादुर गिरी',
        ...
        ('household_007', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 3, 
         'KH-W3-002', 'KH-F-007', '2023-09-21',
         ARRAY[81.6934, 28.1512], 'उत्तर परिवर्तन', 'संगिता कुमारी बस्नेत',
        ...
        -- Ward 4
        ('household_008', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 4, 
         'KH-W4-001', 'KH-F-008', '2023-09-22',
         ARRAY[81.7015, 28.1578], 'दक्षिण परिवर्तन', 'दिनेश थापा',
        ...
        ('household_009', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 4, 
         'KH-W4-002', 'KH-F-009', '2023-09-23',
         ARRAY[81.7034, 28.1592], 'दक्षिण परिवर्तन', 'सुमन पौडेल',
        ...
        -- Ward 5
        ('household_010', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 5, 
         'KH-W5-001', 'KH-F-010', '2023-09-24',
         ARRAY[81.7112, 28.1634], 'पूर्व परिवर्तन', 'मनोज कुमार यादव',
         '9850123456', 5, 'own', 'own', 'concrete', 'brick', 'rcc', 'concrete',
         2, 5, 'yes', 'yes', 'safe', 'UNDER_15_MIN', 'UNDER_30_MIN',
         ST_SetSRID(ST_MakePoint(81.7112, 28.1634), 4326)),
         
        ('household_011', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 5, 
         'KH-W5-002', 'KH-F-011', '2023-09-25',
         ARRAY[81.7134, 28.1645], 'पूर्व परिवर्तन', 'राजेन्द्र बहादुर कार्की',
        ...
        -- Ward 6
        ('household_012', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 6, 
         'KH-W6-001', 'KH-F-012', '2023-09-26',
         ARRAY[81.7215, 28.1678], 'मध्य परिवर्तन', 'शिव प्रसाद पन्त',
        ...
        ('household_013', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 6, 
         'KH-W6-002', 'KH-F-013', '2023-09-27',
         ARRAY[81.7234, 28.1689], 'मध्य परिवर्तन', 'लक्ष्मी देवी पौडेल',
         '9853456789', 3, 'rent', 'rent', 'concrete', 'brick', 'rcc', 'concrete',
         3, 6, 'yes', 'yes', 'safe', 'UNDER_30_MIN', 'UNDER_30_MIN',
         ST_SetSRID(ST_MakePoint(81.7234, 28.1689), 4326)),
         
        -- Ward 7
        ('household_014', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 7, 
        ...
        ('household_015', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 7, 
        ...
        -- Ward 8
        ('household_016', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 8, 
        ...
        ('household_017', 'Paribartan', 'lumbini', '58', 'परिवर्तन गाउँपालिका', 8, 
