...
COMMENT ON TABLE acme_ward_wise_households_in_agriculture IS 'Stores ward-wise data on households involved in agriculture for Paribartan Rural Municipality';
