...
COMMENT ON TABLE acme_ward_wise_time_to_financial_organization IS 'Stores ward-wise data on time taken to reach financial organizations for pariwartan Rural Municipality';
