...
export const business = pgTable("acme_pariwartan_business", {
...
export const stagingBusiness = pgTable("staging_acme_pariwartan_businesses", {
  // Primary identification
  id: text("id").primaryKey().notNull(),
  wardNo: integer("ward_no").notNull(),
  tenantId: text("tenant_id"),
...
export const businessEditRequests = pgTable("acme_pariwartan_business_edit_requests", {
