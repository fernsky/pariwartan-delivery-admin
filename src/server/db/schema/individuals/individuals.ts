...
export const individuals = pgTable("acme_pariwartan_individuals", {
...
export const stagingIndividuals = pgTable("staging_acme_pariwartan_individuals", {
...
export const individualEditRequests = pgTable("acme_pariwartan_individual_edit_requests", {
