...
import { FileDown, Search, Phone, Mail, User } from "lucide-react";
...
interface AgricultureRepresentativesTableProps {
  representativesData: Representative[];
  totalRepresentatives: number;
}

export default function AgricultureRepresentativesTable({
  representativesData,
  totalRepresentatives,
}: AgricultureRepresentativesTableProps) {
              ...
              <CardContent className="pt-0">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href={`tel:${representative.contactNumber}`}
      ...
      <div className="hidden md:block border rounded-lg shadow-sm overflow-hidden bg-card">
        <div className="border-b px-4 py-3">
          <h3 className="text-lg font-semibold">
            कृषि प्रतिनिधिहरूको विस्तृत तालिका
          </h3>
          <p className="text-sm text-muted-foreground">
            कुल {formatNepaliNumber(filteredData.length)} जना कृषि प्रतिनिधि
          </p>
        </div>
          ...
          <table className="w-full border-collapse text-sm">
            <thead className="bg-muted sticky top-0 z-10">
              <tr>
                ...
                <th className="border p-3 text-left min-w-[180px]">पद</th>
                <th className="border p-3 text-left min-w-[120px]">
                  सम्पर्क नम्बर
                </th>
                <th className="border p-3 text-left min-w-[100px]">शाखा</th>
                {/* <th className="border p-3 text-left min-w-[100px]">कैफियत</th>
                <th className="border p-3 text-center min-w-[80px]">कार्य</th> */}
              </tr>
            </thead>
            <tbody>
            ...
            {representativesData.slice(0, 4).map((representative) => (
              ...
              >
                ...
                <Button
                  ...
                  className="w-full"
                  onClick={() =>
                    window.open(`tel:${representative.contactNumber}`)
                  }
                >
