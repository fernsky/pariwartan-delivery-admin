...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionEN = `Detailed list of staff working in the Agriculture branch of pariwartan Rural Municipality. Complete information of ${totalRepresentatives} agriculture representatives including names, positions, contact numbers and other details. Contact information for agriculture services and support.`;
