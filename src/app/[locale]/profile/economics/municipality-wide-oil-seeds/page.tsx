...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका तेलहन बाली",
      "परिवर्तन तेलहनको उत्पादन",
      "पालिका स्तरीय तेलहन बाली तथ्याङ्क",
      "तोरी/सरसोँ उत्पादन परिवर्तन",
      "आलस उत्पादन तथ्याङ्क",
      "सूर्यमूखी उत्पादन",
      `परिवर्तन तेलहन बाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `परिवर्तन तेलहन बाली आय ${localizeNumber((totalRevenue / 1000000).toFixed(2), "ne")} मिलियन`,
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality oil seeds",
      "pariwartan oil seed production",
      "Municipality-wide oil seed statistics",
      "Mustard production in pariwartan",
      "Flax cultivation statistics",
      "Sunflower production data",
      `pariwartan oil seed sales ${totalSales.toFixed(2)} tonnes`,
      `pariwartan oil seed revenue ${(totalRevenue / 1000000).toFixed(2)} million rupees`,
    ];
    ...
    const descriptionEN = `Analysis of oil seed production and sales in pariwartan Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of oil seed production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${OIL_SEED_TYPES_EN[mostProducedOilSeed] || mostProducedOilSeed}. Detailed analysis of municipality-wide oil seed patterns.`;
    ...
    return {
      title:
        "तेलहन बालीको प्रकार अनुसार उत्पादन र बिक्री | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तेलहन बालीको प्रकार अनुसार उत्पादन र बिक्री - परिवर्तन गाउँपालिका (Oil Seeds by Production and Sales - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा तेलहन बालीको प्रकार अनुसार उत्पादन र बिक्री
            </h1>
            ...
            <p>
              तेलहन बाली परिवर्तन गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये एक
            ...
            <p>
              परिवर्तन गाउँपालिकाको तेलहन बाली सम्बन्धी तथ्याङ्क अनुसार, यस
            ...
            <p>
              परिवर्तन गाउँपालिकामा उत्पादित प्रमुख तेलहन बालीहरू र तिनको
            ...
            <p>
              तेलहन बालीको विश्लेषण गर्दा, परिवर्तन गाउँपालिकामा उत्पादित कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा तेलहन बालीको उत्पादनले स्थानीय अर्थतन्त्रमा
            ...
            <p>
              परिवर्तन गाउँपालिकाको प्रमुख तेलहन बालीको उत्पादकत्व र बजारीकरणको
            ...
            <p>
              परिवर्तन गाउँपालिकाको तेलहन बालीको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              परिवर्तन गाउँपालिकामा तेलहन बालीको वर्तमान अवस्थाले अझै विकासको
