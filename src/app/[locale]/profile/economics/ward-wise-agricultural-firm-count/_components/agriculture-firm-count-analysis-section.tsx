    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-lg font-medium mb-4">
          कृषि फर्म विश्लेषण
          <span className="sr-only">
            Agriculture Firms Analysis of pariwartan
          </span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <h4 className="font-medium mb-2 text-sm">
              ...
              <span className="sr-only">
                Ward with most agriculture firms in pariwartan
              </span>
            </h4>
          ...
          >
            <h4 className="font-medium mb-2 text-sm">
              प्रति वडा औसत
              <span className="sr-only">
                Average agriculture firms per ward in pariwartan
              </span>
            </h4>
            <p className="text-2xl font-bold">
          ...
          >
            <h4 className="font-medium mb-2 text-sm">
              ...
              <span className="sr-only">
                Ward with least agriculture firms in pariwartan
              </span>
            </h4>
            <p className="text-2xl font-bold">
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-4">
        <h3 className="text-lg font-medium mb-3">
          ...
          <span className="sr-only">
            Agriculture Firms Distribution Analysis of pariwartan Rural
            Municipality
          </span>
        </h3>
