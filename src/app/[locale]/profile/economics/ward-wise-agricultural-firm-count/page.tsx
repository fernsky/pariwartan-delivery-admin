...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality agriculture firms",
      "pariwartan agricultural groups count",
      "Ward-wise agriculture firms",
      "Agricultural enterprise statistics",
      "Agriculture development pariwartan",
      `pariwartan total agriculture firms ${totalFirms}`,
