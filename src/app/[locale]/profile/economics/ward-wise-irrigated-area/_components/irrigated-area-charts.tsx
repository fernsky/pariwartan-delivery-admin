  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Irrigated Area in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Ward-wise irrigated and unirrigated area in pariwartan with a total area of ${totalArea.toFixed(2)} hectares`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Irrigated and Unirrigated Area Distribution in pariwartan"
        />
        <meta
          itemProp="description"
          content="Distribution of irrigated and unirrigated area across wards in pariwartan Rural Municipality"
        />
