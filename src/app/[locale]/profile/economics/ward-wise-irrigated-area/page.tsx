...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality ward-wise irrigated area",
      "Ward-wise irrigated and unirrigated area statistics",
      "Irrigation coverage by ward",
      `pariwartan irrigated area ${totalIrrigatedArea.toFixed(2)} hectares`,
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वडा अनुसार सिंचित र असिंचित क्षेत्रफल - परिवर्तन गाउँपालिका (Ward-wise Irrigated and Unirrigated Area - pariwartan Rural Municipality)"
