        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वित्तीय खाताको वितरण - परिवर्तन गाउँपालिका (Distribution of Financial Accounts - pariwartan Rural Municipality)"
