...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality household income sources",
      "pariwartan economic activities",
      `pariwartan ${incomeSourceLabels[topIncomeSources[0] as keyof typeof incomeSourceLabels]}`,
      ...topIncomeSources.map(
        (r) =>
          `${incomeSourceLabels[r as keyof typeof incomeSourceLabels]} households in pariwartan`,
      ),
      "Ward-wise household income sources",
      "Economic activity statistics",
      "Income source survey pariwartan",
    ...
    const descriptionEN = `Ward-wise household income source distribution, trends and analysis for pariwartan Rural Municipality. Out of a total of ${totalHouseholds} households, ${
      incomeSourceLabels[topIncomeSources[0] as keyof typeof incomeSourceLabels]
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरपरिवारको आय स्रोत - परिवर्तन गाउँपालिका (Household Income Sources - pariwartan Rural Municipality)"
