...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality vegetables",
      "pariwartan vegetable production",
      "Municipality-wide vegetable statistics",
      "Potato production in pariwartan",
      "Tomato cultivation statistics",
      "Cauliflower production data",
      `pariwartan vegetable sales ${totalSales.toFixed(2)} tonnes`,
      `pariwartan vegetable revenue ${(totalRevenue / 1000).toFixed(2)} thousand rupees`,
    ];
    ...
    const descriptionEN = `Analysis of vegetable production and sales in pariwartan Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of vegetable production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${VEGETABLE_TYPES_EN[mostProducedVegetable] || mostProducedVegetable}. Detailed analysis of municipality-wide vegetable patterns.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तरकारीको प्रकार अनुसार उत्पादन र बिक्री - परिवर्तन गाउँपालिका (Vegetables by Production and Sales - pariwartan Rural Municipality)"
