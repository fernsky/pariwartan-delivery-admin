...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality annual income sufficiency",
      "Yearly income sustenance",
      `pariwartan ${monthsSustainedLabels[sortedMonthsSustained[0] as keyof typeof monthsSustainedLabels]}`,
      ...sortedMonthsSustained.map(
        (r) =>
          `${monthsSustainedLabels[r as keyof typeof monthsSustainedLabels]} households in pariwartan`,
      ),
      "Ward-wise income sustenance",
      "Economic self-reliance statistics",
      "Income sufficiency survey pariwartan",
            ...
            <section>
              <div className="relative rounded-lg overflow-hidden mb-8">
                <Image
                  ...
                  width={1200}
                  height={400}
                  alt="वार्षिक आयको पर्याप्तता - परिवर्तन गाउँपालिका (Yearly Income Sustenance - pariwartan Rural Municipality)"
