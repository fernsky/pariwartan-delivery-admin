...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality fruits",
      "pariwartan fruit production",
      "Municipality-wide fruit statistics",
      "Mango production in pariwartan",
      "Jackfruit cultivation statistics",
      "Litchi production data",
      `pariwartan fruit sales ${totalSales.toFixed(2)} tonnes`,
      `pariwartan fruit revenue ${(totalRevenue / 1000000).toFixed(2)} million rupees`,
    ];
    ...
    const descriptionEN = `Analysis of fruit production and sales in pariwartan Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of fruit production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${FRUIT_TYPES_EN[mostProducedFruit] || mostProducedFruit}. Detailed analysis of municipality-wide fruit patterns.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="फलफूल बालीको प्रकार अनुसार उत्पादन र बिक्री - परिवर्तन गाउँपालिका (Fruits by Production and Sales - pariwartan Rural Municipality)"
