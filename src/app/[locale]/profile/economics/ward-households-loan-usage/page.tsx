...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality loan usage",
      "pariwartan credit purposes",
      `pariwartan ${loanUseLabels[topLoanUses[0]]} loans`,
      ...topLoanUses.map(
        (r) => `${loanUseLabels[r]} purpose loans in pariwartan`,
      ),
      "Ward-wise loan usage",
      "Credit purpose statistics",
      "Loan utilization survey pariwartan",
      `pariwartan total households with loans ${totalHouseholds}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कर्जाको उपयोग प्रयोजन - परिवर्तन गाउँपालिका (Loan Usage Purposes - pariwartan Rural Municipality)"
