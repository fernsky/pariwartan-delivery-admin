  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Skills Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Distribution of skills in pariwartan with a total of ${totalPopulation} skilled population`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Skills Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Skills distribution across wards in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Detailed Skills Analysis by Ward in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Detailed skills composition of each ward in pariwartan"
        />
