...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality spices",
      "pariwartan spice production",
      "Municipality-wide spice statistics",
      "Garlic production in pariwartan",
      "Chili pepper cultivation statistics",
      "Coriander production data",
      `pariwartan spice sales ${totalSales.toFixed(2)} tonnes`,
      `pariwartan spice revenue ${(totalRevenue / 1000).toFixed(2)} thousand rupees`,
    ];
    ...
    const descriptionEN = `Analysis of spice production and sales in pariwartan Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of spice production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${SPICE_TYPES_EN[mostProducedSpice] || mostProducedSpice}. Detailed analysis of municipality-wide spice patterns.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="मसलाबालीको प्रकार अनुसार उत्पादन र बिक्री - परिवर्तन गाउँपालिका (Spices by Production and Sales - pariwartan Rural Municipality)"
