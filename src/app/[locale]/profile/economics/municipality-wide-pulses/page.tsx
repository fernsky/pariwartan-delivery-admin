...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "खजुरा गाउँपालिका दालबाली",
      "खजुरा दालहरुको उत्पादन",
      "पालिका स्तरीय दालबाली तथ्याङ्क",
      "मसुरो उत्पादन खजुरा",
      "चना उत्पादन तथ्याङ्क",
      "केराउ उत्पादन",
      `खजुरा दालबाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `खजुरा दालबाली आय ${localizeNumber((totalRevenue / 1000000).toFixed(2), "ne")} मिलियन`,
    ];
    ...
    return {
      title:
        "दालबालीको प्रकार अनुसार उत्पादन र बिक्री | खजुरा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="दालबालीको प्रकार अनुसार उत्पादन र बिक्री - खजुरा गाउँपालिका (Pulses by Production and Sales - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              दालबाली खजुरा गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये एक हो।
            ...
            <p>
              खजुरा गाउँपालिकाको दालबाली सम्बन्धी तथ्याङ्क अनुसार, यस क्षेत्रमा
              वार्षिक कुल {localizeNumber(totalProduction.toFixed(2), "ne")}{" "}
              मेट्रिक टन दालबाली उत्पादन हुन्छ, जसमध्ये सबैभन्दा बढी{" "}
            ...
            <p>
              खजुरा गाउँपालिकामा उत्पादित प्रमुख दालबालीहरू र तिनको उत्पादन
            ...
            <p>
              दालबालीको विश्लेषण गर्दा, खजुरा गाउँपालिकामा उत्पादित कुल दालबाली
              मध्ये {localizeNumber(soldPercentage, "ne")}% बिक्रीका लागि बजारमा
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              खजुरा गाउँपालिकामा दालबालीको उत्पादनले पोषण सुरक्षामा महत्त्वपूर्ण
              भूमिका खेल्दछ। कुल{" "}
            ...
            <p>
              खजुरा गाउँपालिकाको प्रमुख दालबालीको उत्पादकत्व र बजारीकरणको
            ...
            <p>
              खजुरा गाउँपालिकाको दालबालीको अवस्थाको विश्लेषणबाट निम्न निष्कर्ष र
            ...
            <p className="mt-6">
              खजुरा गाउँपालिकामा दालबालीको वर्तमान अवस्थाले अझै पनि कृषि
