...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका दालबाली",
      "परिवर्तन दालहरुको उत्पादन",
      "पालिका स्तरीय दालबाली तथ्याङ्क",
      "मसुरो उत्पादन परिवर्तन",
      "चना उत्पादन तथ्याङ्क",
      "केराउ उत्पादन",
      `परिवर्तन दालबाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `परिवर्तन दालबाली आय ${localizeNumber((totalRevenue / 1000000).toFixed(2), "ne")} मिलियन`,
    ];

    const keywordsEN = [
      "Paribartan Rural Municipality pulses",
      "Paribartan pulse production",
      "Municipality-wide pulse statistics",
      "Lentil production in Paribartan",
      "Chickpea cultivation statistics",
      "Pea production data",
      `Paribartan pulse sales ${totalSales.toFixed(2)} tonnes`,
      `Paribartan pulse revenue ${(totalRevenue / 1000000).toFixed(2)} million rupees`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `परिवर्तन गाउँपालिकाको दालबाली उत्पादन र बिक्री विश्लेषण। कुल ${localizeNumber(totalProduction.toFixed(2), "ne")} मेट्रिक टन दालबाली उत्पादन मध्ये ${localizeNumber(mostProducedPercentage, "ne")}% (${localizeNumber(mostProducedAmount.toFixed(2), "ne")} टन) ${PULSE_TYPES[mostProducedPulse] || mostProducedPulse} रहेको छ। पालिका स्तरीय दालबालीको विस्तृत विश्लेषण।`;

    const descriptionEN = `Analysis of pulse production and sales in Paribartan Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of pulse production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${PULSE_TYPES_EN[mostProducedPulse] || mostProducedPulse}. Detailed analysis of municipality-wide pulse patterns.`;
    ...
    return {
      title:
        "दालबालीको प्रकार अनुसार उत्पादन र बिक्री | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="दालबालीको प्रकार अनुसार उत्पादन र बिक्री - परिवर्तन गाउँपालिका (Pulses by Production and Sales - Paribartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा दालबालीको प्रकार अनुसार उत्पादन र बिक्री
            </h1>
            ...
            <p>
              दालबाली परिवर्तन गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये एक हो।
            ...
            <p>
              परिवर्तन गाउँपालिकाको दालबाली सम्बन्धी तथ्याङ्क अनुसार, यस
            ...
            <p>
              परिवर्तन गाउँपालिकामा उत्पादित प्रमुख दालबालीहरू र तिनको उत्पादन
            ...
            <p>
              दालबालीको विश्लेषण गर्दा, परिवर्तन गाउँपालिकामा उत्पादित कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा दालबालीको उत्पादनले पोषण सुरक्षामा
            ...
            <p>
              परिवर्तन गाउँपालिकाको प्रमुख दालबालीको उत्पादकत्व र बजारीकरणको
            ...
            <p>
              परिवर्तन गाउँपालिकाको दालबालीको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              परिवर्तन गाउँपालिकामा दालबालीको वर्तमान अवस्थाले अझै पनि कृषि
