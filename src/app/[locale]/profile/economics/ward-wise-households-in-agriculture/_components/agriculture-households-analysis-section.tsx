    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">Agricultural Involvement Analysis of Khajura</span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            ...
            data-percentage={highestInvolvementWard?.involvedPercentage.toFixed(2)}
          >
            <h4 className="font-medium mb-2">
              उच्च कृषि आबद्धता भएको वडा
              <span className="sr-only">
                Ward with Highest Agricultural Involvement in Khajura Rural Municipality
              </span>
            </h4>
            <p className="text-3xl font-bold">
              वडा {localizeNumber(highestInvolvementWard?.wardNumber.toString() || "", "ne")}
            </p>
            <p className="text-sm text-muted-foreground mt-2">
              कृषि आबद्धता: {localizeNumber(highestInvolvementWard?.involvedPercentage.toFixed(2) || "0", "ne")}% 
              ({localizeNumber(highestInvolvementWard?.involvedHouseholds.toLocaleString() || "0", "ne")} घरधुरी)
              <span className="sr-only">
                {highestInvolvementWard?.involvedPercentage.toFixed(2) || 0}% agricultural involvement
                ({highestInvolvementWard?.involvedHouseholds.toLocaleString() || 0} households)
              </span>
            </p>
          </div>
          ...
          <div
            ...
            data-percentage={lowestInvolvementWard?.involvedPercentage.toFixed(2)}
          >
            <h4 className="font-medium mb-2">
              न्यून कृषि आबद्धता भएको वडा
              <span className="sr-only">Ward with Lowest Agricultural Involvement in Khajura</span>
            </h4>
            <p className="text-3xl font-bold">
              वडा {localizeNumber(lowestInvolvementWard?.wardNumber.toString() || "", "ne")}
            </p>
            <p className="text-sm text-muted-foreground mt-2">
              कृषि आबद्धता: {localizeNumber(lowestInvolvementWard?.involvedPercentage.toFixed(2) || "0", "ne")}%
              ({localizeNumber(lowestInvolvementWard?.involvedHouseholds.toLocaleString() || "0", "ne")} घरधुरी)
              <span className="sr-only">
                {lowestInvolvementWard?.involvedPercentage.toFixed(2) || 0}% agricultural involvement
                ({lowestInvolvementWard?.involvedHouseholds.toLocaleString() || 0} households)
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 bg-card p-4 rounded border">
          <h4 className="font-medium mb-2">
            ...
            <span className="sr-only">Ward-wise Agricultural Involvement Analysis</span>
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div key={index}>
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {localizeNumber(ward.involvedPercentage.toFixed(2), "ne")}%
                      </span>
                    </div>
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-muted-foreground">
                {involvedPercentage < 40 ? (
                  <p>
                    कृषि आबद्धता दर {localizeNumber(involvedPercentage.toFixed(2), "ne")}% मात्र रहेकोले कृषि क्षेत्रमा थप प्रोत्साहन र सहयोग आवश्यक देखिन्छ।
                  </p>
                ) : involvedPercentage < 60 ? (
                  <p>
                    मध्यम स्तरको कृषि आबद्धता ({localizeNumber(involvedPercentage.toFixed(2), "ne")}%) रहेकाले कृषि क्षेत्रको व्यावसायिकरण र आधुनिकीकरणमा जोड दिनुपर्ने देखिन्छ।
                  </p>
                ) : (
                  <p>
                    उच्च कृषि आबद्धता ({localizeNumber(involvedPercentage.toFixed(2), "ne")}%) रहेकाले मूल्य श्रृंखला विकास र बजारीकरणमा ध्यान दिनुपर्ने देखिन्छ।
                  </p>
                )}
                <div className="mt-2">
                  <p>
                    वडा {localizeNumber(highestInvolvementWard?.wardNumber.toString() || "", "ne")} र वडा {localizeNumber(wardWiseAnalysis[1]?.wardNumber.toString() || "", "ne")} मा विशेष कृषि पकेट क्षेत्र विकास गर्न सकिने सम्भावना रहेको छ।
                  </p>
                </div>
              </div>
            </div>
