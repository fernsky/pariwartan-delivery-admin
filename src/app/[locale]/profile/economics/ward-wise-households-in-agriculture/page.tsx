...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality agriculture households",
      "pariwartan farming animal husbandry families",
      "Ward-wise agriculture households",
      "Households involved in farming",
      "Agricultural population distribution",
      `pariwartan agriculture households ${totalInvolved}`,
      "pariwartan non-agricultural families",
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कृषि वा पशुपालनमा आबद्ध घरपरिवार - परिवर्तन गाउँपालिका (Households Involved in Agriculture - pariwartan Rural Municipality)"
