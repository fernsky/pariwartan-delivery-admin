...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका वैदेशिक रोजगारी",
      "परिवर्तन वैदेशिक रोजगारीका गन्तव्य देशहरू",
      "वडा अनुसार वैदेशिक रोजगारी",
      "विदेशमा रोजगारीमा गएका परिवर्तनवासीहरू",
      COUNTRY_NAMES[mostCommonCountry] || mostCommonCountry,
      `परिवर्तन वैदेशिक रोजगारी संख्या ${localizeNumber(totalPopulation.toString(), "ne")}`,
    ...
    const descriptionNP = `परिवर्तन गाउँपालिकाको वडा अनुसार वैदेशिक रोजगारीमा गएका जनसंख्याको वितरण र विश्लेषण। कुल ${localizeNumber(totalPopulation.toString(), "ne")} जना वैदेशिक रोजगारीमा रहेका छन्, जसमध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ${COUNTRY_NAMES[mostCommonCountry] || mostCommonCountry} मा रहेका छन्। विभिन्न वडाहरूमा वैदेशिक रोजगारीको विस्तृत विश्लेषण।`;
    ...
    return {
      title:
        "वैदेशिक रोजगारीका गन्तव्य देशहरू | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वैदेशिक रोजगारीका गन्तव्य देशहरू - परिवर्तन गाउँपालिका (Foreign Employment Destinations - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा वैदेशिक रोजगारीका गन्तव्य देशहरू
            </h1>
            ...
            <p>
              ...
              परिवर्तन गाउँपालिकामा पनि यो क्षेत्र आर्थिक विकासको महत्वपूर्ण
              आधार बनेको छ।
            </p>
            <p>
              परिवर्तन गाउँपालिकाको वैदेशिक रोजगारी सम्बन्धी तथ्याङ्क अनुसार,
            ...
            <p>
              परिवर्तन गाउँपालिकाका वासिन्दाहरूको वैदेशिक रोजगारीका प्रमुख
            ...
            <p>
              क्षेत्रगत विश्लेषण गर्दा, परिवर्तन गाउँपालिकाका{" "}
              {localizeNumber(
                (
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा वैदेशिक रोजगारीबाट प्राप्त रेमिट्यान्सले
            ...
            <p>
              ...
              हुनाले स्थानीय विकासका लागि यो महत्वपूर्ण स्रोत हो। परिवर्तन
            ...
            <p>
              परिवर्तन गाउँपालिकामा वैदेशिक रोजगारीको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              परिवर्तन गाउँपालिकामा वैदेशिक रोजगारीको वर्तमान अवस्था मध्यम
