  ...
  const generateStructuredData = () => {
    ...
    const timeToFinancialOrgStats = wardNumbers
      .map((wardNumber) => {
        ...
        return {
          "@type": "Observation",
          name: `Financial Access in Ward ${wardNumber} of Paribartan Rural Municipality`,
          ...
          description: `In Ward ${wardNumber} of Paribartan Rural Municipality, ${under15Min.toLocaleString()} households (${under15MinPercent}%) can reach a financial institution within 15 minutes out of a total of ${totalWardHouseholds.toLocaleString()} households.`,
        };
      })
      .filter(Boolean);
    ...
    return {
      ...
      url: "https://paribartan.digprofile.com/profile/economics/ward-wise-time-to-financial-organization",
      creator: {
        "@type": "Organization",
