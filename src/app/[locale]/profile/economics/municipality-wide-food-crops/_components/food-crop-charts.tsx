  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Food Crop Types in pariwartan Rural Municipality"
        />
        <meta
      ...
      >
        <meta
          itemProp="name"
          content="Food Crop Production vs Sales Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Distribution of production and sales of food crops in pariwartan"
        />
