...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality food crops",
      "pariwartan food crop production",
      "Municipality-wide food crop statistics",
      "Paddy production in pariwartan",
      "Corn cultivation statistics",
      "Wheat production data",
      `pariwartan food crop sales ${totalSales.toFixed(2)} tonnes`,
      `pariwartan agriculture revenue ${(totalRevenue / 1000000).toFixed(2)} million rupees`,
    ];
    ...
    const descriptionEN = `Analysis of food crop production and sales in pariwartan Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of food crop production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${FOOD_CROP_TYPES_EN[mostProducedCrop] || mostProducedCrop}. Detailed analysis of municipality-wide food crop patterns.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खाद्यान्न बालीको प्रकार अनुसार उत्पादन र बिक्री - परिवर्तन गाउँपालिका (Food Crops by Production and Sales - pariwartan Rural Municipality)"
