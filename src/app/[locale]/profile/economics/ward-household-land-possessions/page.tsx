...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका भूमि स्वामित्व",
      "परिवर्तन जग्गाधनी परिवार",
      "परिवर्तन आर्थिक स्थिति",
      `परिवर्तन वडा ${wardsWithHighestLandPossession[0]?.wardNumber || ""} भूमि स्वामित्व`,
      "वडा अनुसार भूमि स्वामित्व",
      "गाउँपालिका जग्गा तथ्याङ्क",
      "आर्थिक सर्वेक्षण परिवर्तन",
      `परिवर्तन कुल जग्गाधनी परिवार संख्या ${totalHouseholdsWithLand}`,
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality land ownership",
      "pariwartan landowner households",
      "pariwartan economic condition",
      `pariwartan ward ${wardsWithHighestLandPossession[0]?.wardNumber || ""} land ownership`,
      "Ward-wise land possession",
      "Rural municipality land statistics",
      "Economic survey pariwartan",
      `pariwartan total households with land ${totalHouseholdsWithLand}`,
    ];
            ...
            <section>
              <div className="relative rounded-lg overflow-hidden mb-8">
                <Image
                  ...
                  width={1200}
                  height={400}
                  alt="घरपरिवारको जग्गा स्वामित्व - परिवर्तन गाउँपालिका (Household Land Ownership - pariwartan Rural Municipality)"
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl">
                <h1 className="scroll-m-20 tracking-tight mb-6">
                  परिवर्तन गाउँपालिकामा घरपरिवारको जग्गा स्वामित्व
                </h1>
                ...
                <p>
                  यस खण्डमा परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा जग्गाधनी
                ...
                <p>
                  परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा जग्गाधनी घरपरिवारहरूको
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl mt-8">
                ...
                <p>
                  परिवर्तन गाउँपालिकामा जग्गा स्वामित्वको वितरण विश्लेषण गर्दा,
                  वडा{" "}
