...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionNP = `खजुरा गाउँपालिकामा संचालित ${localizeNumber(totalGroups.toString(), "ne")} कृषि सम्बन्धित समूहहरूको विस्तृत विश्लेषण। वडा नं ${localizeNumber(wardWithMostGroups.toString(), "ne")} मा सबैभन्दा बढी ${localizeNumber(wardMaxCount.toString(), "ne")} समूहहरू क्रियाशील छन्। पालिका स्तरीय कृषि समूहहरूको विस्तृत जानकारी।`;
    ...
    return {
      title:
        "कृषि सम्बन्धित समूहहरू | खजुरा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        "पालिका स्तरीय कृषि सम्बन्धित समूहहरूको विवरण र विश्लेषण।",
    };
  }
}
...
export default async function AgricultureRelatedFarmersGroupPage() {
  ...
  const getGroupType = (name: string) => {
    if (name.includes("महिला") && name.includes("दलित")) return "दलित महिला कृषक समुह";
  ...
  const popularGroupByWard = farmsByWard.map(ward => {
    const groupTypes = ward.farms.reduce((acc: Record<string, number>, farm) => {
  ...
  const statistics = {
    ...
    mostPopularGroupTypePercentage: groupSummary.length > 0 ? groupSummary[0].percentage : 0,
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कृषि सम्बन्धित समूहहरू - खजुरा गाउँपालिका (Agriculture Related Farmers Groups - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              खजुरा गाउँपालिकामा कृषि सम्बन्धित समूहहरू
            </h1>
            ...
            <p>
              कृषि सम्बन्धित समूहहरू खजुरा गाउँपालिकाको आर्थिक विकासमा महत्त्वपूर्ण
              भूमिका निर्वाह गरिरहेका छन्। यस गाउँपालिकामा रहेका विभिन्न कृषक समूह,
              महिला कृषक समूह, दलित कृषक समूह लगायतका संगठित समूहहरूले कृषि उत्पादन
              र विकासमा योगदान पुर्‍याइरहेका छन्।
            </p>
            <p>
              यी समूहहरूले स्थानीय स्तरमा कृषि प्रविधि, बीउ बिजन वितरण, तालिम,
              क्षमता विकास, र उत्पादित वस्तुहरूको बजारीकरणमा सहयोग गर्दै आइरहेका छन्। 
              यस पृष्ठमा गाउँपालिकामा संचालित कृषि सम्बन्धित विभिन्न समूहहरूको
              विस्तृत विवरण र विश्लेषण प्रस्तुत गरिएको छ।
            </p>

            <p>
              खजुरा गाउँपालिकामा कुल {localizeNumber(totalGroups.toString(), "ne")}{" "}
              कृषि सम्बन्धित समूहहरू रहेका छन्, जसमध्ये वडा नं.
              {" "}{localizeNumber(statistics.wardWithMostGroups.toString(), "ne")} मा
              {" "}{localizeNumber(statistics.maximumGroupsInAWard.toString(), "ne")} वटा
              समूहहरू रहेका छन्।
            </p>
            ...
            <p>
              खजुरा गाउँपालिकाका विभिन्न वडाहरूमा कृषि सम्बन्धित समूहहरूको वितरण
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
              ...
              <div>
                ...
                <ul className="space-y-2 mt-4">
                  <li className="flex gap-2">
                    ...
                    <span>
                      <strong>प्राविधिक ज्ञानको कमी:</strong> आधुनिक कृषि प्रविधि र ज्ञानको कमीले उत्पादकत्व वृद्धिमा बाधा
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-red-500">•</span>
                    <span>
                      <strong>बजारीकरणको समस्या:</strong> उत्पादित वस्तुहरूको उचित मूल्य र बजार पहुँचको कमी
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-red-500">•</span>
                    <span>
                      <strong>आर्थिक स्रोतको अभाव:</strong> समूहहरूको क्षमता विकास र आधुनिकीकरणका लागि पूँजीको कमी
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-red-500">•</span>
                    <span>
                      <strong>समन्वयको कमी:</strong> स्थानीय सरकार र समूहहरू बीच प्रभावकारी समन्वय र सहकार्यको अभाव
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 mt-4">
                  <li className="flex gap-2">
                    ...
                    <span>
                      <strong>सामूहिक खेती:</strong> समूहमा आधारित कृषि उत्पादन र बजारीकरणको अवसर
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-green-500">•</span>
                    <span>
                      <strong>ज्ञान र अनुभव आदानप्रदान:</strong> समूह सदस्यहरू बीच सिकाइ र अनुभव आदानप्रदानको अवसर
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-green-500">•</span>
                    <span>
                      <strong>सहुलियत र अनुदान:</strong> समूहगत रूपमा सरकारी सहुलियत र अनुदान प्राप्तिको अवसर
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-green-500">•</span>
                    <span>
                      <strong>मूल्य शृङ्खला विकास:</strong> कृषि उत्पादनको प्रशोधन र मूल्य शृङ्खला विकासको सम्भावना
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <p>
              खजुरा गाउँपालिकामा कृषि सम्बन्धित समूहहरूको अवस्थाको विश्लेषणबाट
            ...
            <div className="pl-6 space-y-4">
              <div className="flex">
                ...
                <div>
                  <strong>क्षमता विकास:</strong> कृषि सम्बन्धित समूहहरूको लागि नियमित
                  तालिम र क्षमता विकासका कार्यक्रमहरू संचालन गर्नुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">२.</span>
                <div>
                  <strong>बजारीकरण सहयोग:</strong> उत्पादित वस्तुहरूको बजारीकरणका
                  लागि स्थानीय बजार केन्द्र स्थापना गर्न र बजार सूचना प्रणालीको
                  विकास गर्न आवश्यक छ।
                </div>
              </div>
              <div className="flex">
              ...
              <div className="flex">
                ...
                <div>
                  <strong>समूह नेटवर्किङ:</strong> विभिन्न वडामा रहेका कृषि समूहहरू
                  बीच अनुभव आदानप्रदान र सहकार्यका लागि नेटवर्क स्थापना गर्नुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">५.</span>
                <div>
                  <strong>उत्पादन वृद्धि कार्यक्रम:</strong> आधुनिक कृषि प्रविधि, उन्नत
                  बीउ र प्राङ्गारिक खेतीमा आधारित उत्पादन वृद्धि कार्यक्रम संचालन
                  गर्नुपर्ने।
                </div>
              </div>
            </div>
            ...
            <p className="mt-6">
              खजुरा गाउँपालिकामा कृषि सम्बन्धित समूहहरूको सुदृढीकरण र क्षमता विकासले
              स्थानीय कृषि उत्पादन वृद्धि, रोजगारी सिर्जना र खाद्य सुरक्षामा
              महत्त्वपूर्ण योगदान पुर्‍याउनेछ। यसका लागि स्थानीय सरकार, कृषि सेवा
              केन्द्र र कृषि समूहहरू बीच निरन्तर सहकार्य र समन्वय आवश्यक छ।
            </p>
          </div>
        </section>
      </div>
