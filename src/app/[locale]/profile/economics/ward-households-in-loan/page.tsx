...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका ऋणमा घरपरिवार",
      "परिवर्तन कर्जा लिने घरपरिवार",
      "परिवर्तन आर्थिक स्थिति",
      `परिवर्तन वडा ${wardsWithHighestLoans[0]?.wardNumber || ""} ऋण`,
      "वडा अनुसार ऋण वितरण",
      "गाउँपालिका कर्जा तथ्याङ्क",
      "आर्थिक सर्वेक्षण परिवर्तन",
      `परिवर्तन कुल ऋणी घरपरिवार संख्या ${totalHouseholdsOnLoan}`,
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality households in debt",
      "pariwartan loan taking households",
      "pariwartan economic condition",
      `pariwartan ward ${wardsWithHighestLoans[0]?.wardNumber || ""} loans`,
      "Ward-wise loan distribution",
      "Rural municipality debt statistics",
      "Economic survey pariwartan",
      `pariwartan total households with loans ${totalHouseholdsOnLoan}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `परिवर्तन गाउँपालिकाको वडा अनुसार ऋण लिएका घरपरिवारहरूको वितरण, प्रवृत्ति र विश्लेषण। कुल ${totalHouseholdsOnLoan} घरपरिवारले कुनै न कुनै प्रकारको कर्जा लिएका छन्। सबैभन्दा बढी ऋणी घरपरिवार भएका वडाहरू: वडा ${wardsWithHighestLoans[0]?.wardNumber || "N/A"} (${wardsWithHighestLoans[0]?.households || 0} घरपरिवार), वडा ${wardsWithHighestLoans[1]?.wardNumber || "N/A"} (${wardsWithHighestLoans[1]?.households || 0} घरपरिवार)। विस्तृत तथ्याङ्क र विजुअलाइजेसन यहाँ पेश गरिएको छ।`;

    const descriptionEN = `Ward-wise distribution, trends and analysis of households with loans in pariwartan Rural Municipality. A total of ${totalHouseholdsOnLoan} households have taken some form of loans. Wards with most households in debt: Ward ${wardsWithHighestLoans[0]?.wardNumber || "N/A"} (${wardsWithHighestLoans[0]?.households || 0} households), Ward ${wardsWithHighestLoans[1]?.wardNumber || "N/A"} (${wardsWithHighestLoans[1]?.households || 0} households). Detailed statistics and visualizations presented here.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="ऋण लिएका घरपरिवार - परिवर्तन गाउँपालिका (Households With Loans - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा ऋण लिएका घरपरिवारहरु
            </h1>
            ...
            <p>
              यस खण्डमा परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा ऋण लिएका
            ...
            <p>
              परिवर्तन गाउँपालिकामा कुल {totalHouseholdsOnLoan.toLocaleString()}{" "}
            ...
            <p>
              परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा ऋणमा रहेका घरपरिवारहरूको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा ऋण लिएका घरपरिवारहरूको विश्लेषण गर्दा,
            ...
            <p>
              माथि प्रस्तुत गरिएका तथ्याङ्कहरू परिवर्तन गाउँपालिकाको आर्थिक
