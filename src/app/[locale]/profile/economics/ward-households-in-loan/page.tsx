...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "खजुरा गाउँपालिका ऋणमा घरपरिवार",
      "खजुरा कर्जा लिने घरपरिवार",
      "खजुरा आर्थिक स्थिति",
      `खजुरा वडा ${wardsWithHighestLoans[0]?.wardNumber || ""} ऋण`,
      "वडा अनुसार ऋण वितरण",
      "गाउँपालिका कर्जा तथ्याङ्क",
      "आर्थिक सर्वेक्षण खजुरा",
      `खजुरा कुल ऋणी घरपरिवार संख्या ${totalHouseholdsOnLoan}`,
    ];
    ...
    const descriptionNP = `खजुरा गाउँपालिकाको वडा अनुसार ऋण लिएका घरपरिवारहरूको वितरण, प्रवृत्ति र विश्लेषण। कुल ${totalHouseholdsOnLoan} घरपरिवारले कुनै न कुनै प्रकारको कर्जा लिएका छन्। सबैभन्दा बढी ऋणी घरपरिवार भएका वडाहरू: वडा ${wardsWithHighestLoans[0]?.wardNumber || "N/A"} (${wardsWithHighestLoans[0]?.households || 0} घरपरिवार), वडा ${wardsWithHighestLoans[1]?.wardNumber || "N/A"} (${wardsWithHighestLoans[1]?.households || 0} घरपरिवार)। विस्तृत तथ्याङ्क र विजुअलाइजेसन यहाँ पेश गरिएको छ।`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="ऋण लिएका घरपरिवार - खजुरा गाउँपालिका (Households With Loans - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              खजुरा गाउँपालिकामा ऋण लिएका घरपरिवारहरु
            </h1>
            ...
            <p>
              यस खण्डमा खजुरा गाउँपालिकाको विभिन्न वडाहरूमा ऋण लिएका
            ...
            <p>
              खजुरा गाउँपालिकामा कुल {totalHouseholdsOnLoan.toLocaleString()}{" "}
            ...
            <p>
              खजुरा गाउँपालिकाको विभिन्न वडाहरूमा ऋणमा रहेका घरपरिवारहरूको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              खजुरा गाउँपालिकामा ऋण लिएका घरपरिवारहरूको विश्लेषण गर्दा,
