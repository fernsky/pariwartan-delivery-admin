...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "Paribartan Rural Municipality trained population",
      "Paribartan skill development",
      "Paribartan trained workforce",
      "Ward-wise trained population",
      "Vocational training statistics",
      "Skill development survey Paribartan",
      `Paribartan total trained population ${totalPopulation}`,
    ];
    ...
    const descriptionEN = `Ward-wise trained population distribution, trends and analysis for Paribartan Rural Municipality. Out of a total trained population of ${totalPopulation}, Ward No. ${highestTrainedWard?.wardNumber || ""} has the highest with ${highestTrainedWard?.trainedPopulation || 0} people. Detailed statistics and visualizations of trained population across various wards.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तालिम प्राप्त जनसंख्या - परिवर्तन गाउँपालिका (Trained Population - Paribartan Rural Municipality)"
