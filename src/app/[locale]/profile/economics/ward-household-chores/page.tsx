...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका घरायसी कामकाज",
      "घरायसी कामकाजमा समय वितरण",
      `परिवर्तन ${TIME_SPENT_NAMES_NP[topTimeCategories[0]]} घरायसी काम`,
      ...
      `परिवर्तन जनसंख्या घरायसी काम ${totalPopulation}`,
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality household chores",
      "Household chores time distribution",
      `pariwartan ${TIME_SPENT_NAMES_EN[topTimeCategories[0]]} household work`,
      ...topTimeCategories.map(
        (t) =>
          `${TIME_SPENT_NAMES_EN[t]} spent on household chores in pariwartan`,
      ),
      "Ward-wise household chores",
      "Time distribution for household work",
      "Household chores statistics",
      `pariwartan population household work ${totalPopulation}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी कामकाज - परिवर्तन गाउँपालिका (Household Chores - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा घरायसी कामकाजमा खर्चिने समय
            </h1>
            ...
            <p>
              यस खण्डमा परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा घरायसी कामकाजमा
            ...
            <p>
              परिवर्तन गाउँपालिकामा कुल {totalPopulation.toLocaleString()}{" "}
            ...
            <p>
              घरायसी कामकाजमा खर्चिने समय अनुसार परिवर्तन गाउँपालिकाको जनसंख्या
              वितरण निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरायसी कामकाजमा खर्चिने समयको विश्लेषण गर्दा
