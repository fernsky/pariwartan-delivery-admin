...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality veterinary representatives",
      "Veterinary staff list",
      "Animal Health Technician",
      "Animal Service Branch employees",
      "pariwartan veterinary team",
    ...
    const descriptionEN = `Detailed list of staff working in the Animal Service branch of pariwartan Rural Municipality. Complete information of ${totalRepresentatives} veterinary representatives including names, positions, contact numbers and other details. Contact information for animal health services and support.`;
