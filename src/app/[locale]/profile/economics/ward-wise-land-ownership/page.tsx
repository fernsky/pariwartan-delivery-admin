...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका जग्गा स्वामित्व",
      "परिवर्तन जग्गा स्वामित्व प्रकार",
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality land ownership",
      "pariwartan land ownership types",
      "Ward-wise land ownership",
      "Private land ownership statistics pariwartan",
      "Public land ownership pariwartan",
      "Guthi land ownership",
      "Village Block land ownership",
      `pariwartan households count ${totalHouseholds}`,
    ];
    ...
    return {
      title:
        "जग्गा स्वामित्वको प्रकार अनुसार घरपरिवार | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="जग्गा स्वामित्वको प्रकार अनुसार घरपरिवार - परिवर्तन गाउँपालिका (Land Ownership Types by Households - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा जग्गा स्वामित्वको प्रकार अनुसार घरपरिवार
            </h1>
            ...
            <p>
              ...
              ब्लक लगायतका प्रकारहरू प्रचलनमा छन्। परिवर्तन गाउँपालिकामा पनि यी
              विभिन्न प्रकारका जग्गा स्वामित्वमा बसोबास गर्ने घरपरिवारहरू रहेका
              छन्।
            </p>
            <p>
              परिवर्तन गाउँपालिकाको जग्गा स्वामित्व सम्बन्धी तथ्याङ्क अनुसार,
            ...
            <p>
              परिवर्तन गाउँपालिकामा जग्गा स्वामित्वका प्रमुख प्रकारहरू र तिनमा
            ...
            <p>
              स्वामित्वको विश्लेषण गर्दा, परिवर्तन गाउँपालिकाका{" "}
              {localizeNumber(
                (
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा जग्गा स्वामित्वको प्रकारले भूमि सुरक्षा र
            ...
            <p>
              परिवर्तन गाउँपालिकाको जग्गा स्वामित्व अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              परिवर्तन गाउँपालिकामा जग्गा स्वामित्वको वर्तमान अवस्थाले जग्गा
