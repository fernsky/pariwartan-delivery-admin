    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          निर्यात विश्लेषण
          <span className="sr-only">Export Analysis of pariwartan</span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-medium mb-2">
              प्रमुख निर्यात वर्ग
              <span className="sr-only">
                Main Export Category in pariwartan Rural Municipality
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topCategory
                  ? `${topCategory.percentage}% of total exports in pariwartan Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              निर्यात तथ्याङ्क
              <span className="sr-only">Export Statistics in pariwartan</span>
            </h4>
            <p className="text-3xl font-bold">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                ...
                {categoryDistribution.length} categories) in pariwartan Rural
                Municipality
              </span>
            </p>
          </div>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Export Potential Analysis for pariwartan Rural Municipality
          </span>
        </h3>
