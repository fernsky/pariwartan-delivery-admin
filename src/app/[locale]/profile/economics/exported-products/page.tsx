...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका निर्यातित उत्पादन",
      "परिवर्तन निर्यातित वस्तुहरू",
      "निर्यातित सामान परिवर्तन",
      "परिवर्तन निर्यात सूची",
      "आर्थिक प्रोफाइल परिवर्तन",
      "निर्यातित वस्तु विश्लेषण",
      "निर्यातित उत्पादनहरूको प्रवृत्ति",
      `परिवर्तन ${totalProducts} निर्यातित उत्पादनहरू`,
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality exported products",
      "pariwartan exported goods",
      "Exported items pariwartan",
      "pariwartan export catalog",
      "Economic profile pariwartan",
      "Exported goods analysis",
      "Exported products trends",
      `pariwartan ${totalProducts} exported products`,
    ];
    ...
    const descriptionEN = `Detailed catalog, trends and analysis of exported products from pariwartan Rural Municipality. A total of ${totalProducts} exported products are registered from the municipality. Detailed statistics and visualizations of various exported goods.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="निर्यातित उत्पादनहरू - परिवर्तन गाउँपालिका (Exported Products - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकाबाट निर्यातित उत्पादनहरू
            </h1>
            ...
            <p>
              यस खण्डमा परिवर्तन गाउँपालिकाबाट निर्यात गरिने विभिन्न
            ...
            <p>
              परिवर्तन गाउँपालिकाबाट दर्ता भएका कुल {totalProducts} निर्यातित
            ...
            <p>
              परिवर्तन गाउँपालिकाबाट निर्यात गरिएका उत्पादनहरूको सूची
              निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकाबाट निर्यात गरिने उत्पादनहरूको प्रवृत्ति र
