...
> = {
  RS_0_TO_49999: {
    ...
    max: 49999,
    color: "#e74c3c",
    label: "न्यून रेमिट्यान्स",
  }, // Low remittance - Red
  RS_50000_TO_99999: {
    min: 50000,
    max: 99999,
    color: "#e67e22",
    label: "निम्न मध्यम रेमिट्यान्स",
  }, // Low-medium - Orange
  RS_100000_TO_149999: {
    min: 100000,
    max: 149999,
    color: "#f39c12",
    label: "मध्यम रेमिट्यान्स",
  }, // Medium - Yellow
  RS_150000_TO_199999: {
    min: 150000,
    max: 199999,
    color: "#f1c40f",
    label: "मध्यम उच्च रेमिट्यान्स",
  }, // Medium-high - Light Yellow
  RS_200000_TO_249999: {
    min: 200000,
    max: 249999,
    color: "#2ecc71",
    label: "उच्च मध्यम रेमिट्यान्स",
  }, // High-medium - Light Green
  RS_250000_TO_299999: {
    min: 250000,
    max: 299999,
    color: "#27ae60",
    label: "सबल रेमिट्यान्स",
  }, // Strong - Green
  RS_300000_TO_349999: {
    min: 300000,
    max: 349999,
    color: "#16a085",
    label: "उच्च रेमिट्यान्स",
  }, // High - Teal
  RS_350000_TO_399999: {
    min: 350000,
    max: 399999,
    color: "#1abc9c",
    label: "अति उच्च रेमिट्यान्स",
  }, // Very high - Light Teal
  RS_400000_TO_449999: {
    min: 400000,
    max: 449999,
    color: "#3498db",
    label: "प्रभावशाली रेमिट्यान्स",
  }, // Influential - Blue
  RS_450000_TO_499999: {
    min: 450000,
    max: 499999,
    color: "#2980b9",
    label: "उत्कृष्ट रेमिट्यान्स",
  }, // Excellent - Dark Blue
  RS_500000_PLUS: {
    min: 500000,
    max: null,
    color: "#8e44ad",
    label: "अत्यधिक रेमिट्यान्स",
  }, // Extreme - Purple
};
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका रेमिट्यान्स",
      "परिवर्तन वडा अनुसार रेमिट्यान्स",
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality remittance",
      "Ward-wise remittance in pariwartan",
    ...
    return {
      title:
        "वडा अनुसार रेमिट्यान्स वितरण | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वडा अनुसार रेमिट्यान्स वितरण - परिवर्तन गाउँपालिका (Ward-wise Remittance Distribution - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा वडा अनुसार रेमिट्यान्स वितरण
            </h1>
            ...
            <p>
              परिवर्तन गाउँपालिकामा वैदेशिक रोजगारीबाट प्राप्त हुने रेमिट्यान्स
            ...
            <p>
              परिवर्तन गाउँपालिकाको रेमिट्यान्स सम्बन्धी तथ्याङ्क अनुसार, कुल{" "}
            ...
            <p>
              परिवर्तन गाउँपालिकामा रेमिट्यान्स पठाउने व्यक्तिहरूको वितरण र रकम
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा वार्षिक रु.{" "}
            ...
            <p>
              परिवर्तन गाउँपालिकामा रेमिट्यान्सको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              ...
              परिचालन गर्न सकेमा परिवर्तन गाउँपालिकाको समृद्धि र आर्थिक
