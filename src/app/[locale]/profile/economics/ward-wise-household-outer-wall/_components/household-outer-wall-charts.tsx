  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="House Outer Wall Types in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`House outer wall distribution of pariwartan with a total of ${totalHouseholds} households`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Outer Wall Quality Analysis in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Quality analysis of house outer walls in pariwartan Rural Municipality"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise House Outer Wall in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="House outer wall distribution across wards in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise House Outer Wall Analysis in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Most common house outer wall types by ward in pariwartan"
        />
