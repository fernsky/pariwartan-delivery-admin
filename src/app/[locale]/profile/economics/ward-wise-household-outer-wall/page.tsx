...
import { OuterWallType, outerWallOptions } from "@/server/api/routers/profile/economics/ward-wise-household-outer-wall.schema";
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const wallData = await api.profile.economics.wardWiseHouseholdOuterWall.getAll.query();
    ...
    const keywordsNP = [
      "खजुरा गाउँपालिका घरको बाहिरी गारो",
      "खजुरा घरको बाहिरी गारो वितरण",
      "वडा अनुसार घरको बाहिरी गारो",
      "घरको बाहिरी गारो विवरण",
      "सिमेन्टको जोडाइ भएको इँटा/ढुङ्गा",
      "माटोको जोडाइ भएको घरहरू",
      `खजुरा घरको बाहिरी गारो संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
      "खजुरा गृह सुरक्षा",
      "खजुरा आवास संरचना",
    ];
    ...
    const descriptionNP = `खजुरा गाउँपालिकाको वडा अनुसार घरको बाहिरी गारोको वितरण र विश्लेषण। कुल घरधुरी संख्या ${localizeNumber(totalHouseholds.toString(), "ne")} मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ${WALL_TYPE_NAMES[mostCommonType] || mostCommonType} प्रकारको बाहिरी गारो भएका घरहरू रहेका छन्। विभिन्न वडाहरूमा घरको बाहिरी गारोको विस्तृत विश्लेषण।`;
    ...
    return {
      title: "घरको बाहिरी गारोको वितरण | खजुरा गाउँपालिका डिजिटल प्रोफाइल",
...
const toc = [
  ...
  { level: 2, text: "घरको बाहिरी गारोका प्रकारहरू", slug: "household-outer-wall-types" },
  { level: 2, text: "वडा अनुसार घरको बाहिरी गारो", slug: "ward-wise-household-outer-wall" },
  { level: 2, text: "बाहिरी गारोको गुणस्तर विश्लेषण", slug: "outer-wall-quality-analysis" },
...
export default async function WardWiseHouseholdOuterWallPage() {
  ...
  try {
    summaryData = await api.profile.economics.wardWiseHouseholdOuterWall.summary.query();
  } catch (error) {
  ...
  const overallSummary = Object.entries(
    ...
    .map(([wallType, households]) => ({
      wallType,
      wallTypeName: WALL_TYPE_NAMES[wallType as keyof typeof WALL_TYPE_NAMES] || wallType,
      households,
    }))
  ...
  const wardWiseData = wardNumbers.map((wardNumber) => {
    ...
    wardData.forEach((item) => {
      const wallName = WALL_TYPE_NAMES[item.wallType as keyof typeof WALL_TYPE_NAMES] || item.wallType;
  ...
  const wardWiseAnalysis = wardNumbers.map((wardNumber) => {
    ...
    const mediumQualityWalls = wardData
      .filter(item => item.wallType === "MUD_JOINED" || item.wallType === "WOOD")
      .reduce((sum, item) => sum + (item.households || 0), 0);
      
    // Calculate low-quality walls (others)
    const lowQualityWalls = wardData
      .filter(item => ["UNBAKED_BRICK", "TIN", "BAMBOO", "OTHER"].includes(item.wallType))
      .reduce((sum, item) => sum + (item.households || 0), 0);
    
    const highQualityPercentage = wardTotalHouseholds > 0 
      ? ((highQualityWalls / wardTotalHouseholds) * 100).toFixed(2)
      : "0";
      
    const mediumQualityPercentage = wardTotalHouseholds > 0 
      ? ((mediumQualityWalls / wardTotalHouseholds) * 100).toFixed(2)
      : "0";
      
    const lowQualityPercentage = wardTotalHouseholds > 0 
    ...
    return {
      ...
      qualityScore: parseInt(highQualityPercentage) * 1 + parseInt(mediumQualityPercentage) * 0.5
    };
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरको बाहिरी गारोको वितरण - खजुरा गाउँपालिका (House Outer Wall Distribution - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              खजुरा गाउँपालिकामा घरको बाहिरी गारोको वितरण
            </h1>
            ...
            <p>
              घरको बाहिरी गारोको प्रकारले घरको संरचनागत बलियोपन, आवासीय गुणस्तर र प्राकृतिक प्रकोप प्रतिको सुरक्षाको स्तर निर्धारण गर्दछ। 
              यस खण्डमा खजुरा गाउँपालिकामा घरको बाहिरी गारोका प्रमुख प्रकारहरू र तिनको वडागत वितरणको विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              खजुरा गाउँपालिकाको घरको बाहिरी गारोको तथ्याङ्क अनुसार, कुल घरधुरी {localizeNumber(totalHouseholds.toLocaleString(), "ne")} 
              मध्ये सबैभन्दा बढी {overallSummary[0]?.wallTypeName.split('(')[0].trim() || ""} 
              गारो भएका घरहरू {localizeNumber(((overallSummary[0]?.households || 0) / totalHouseholds * 100).toFixed(1), "ne")}% 
              रहेका देखिन्छन्। अन्य प्रकारका गारो भएका घरहरूको संख्या क्रमशः घट्दो क्रममा रहेको छ।
            </p>
            ...
            <p>
              खजुरा गाउँपालिकामा घरको बाहिरी गारोका प्रमुख प्रकारहरू र तिनको वितरण निम्नानुसार
              रहेको छ:
            </p>
            ...
            <ul>
              {overallSummary.slice(0, 3).map((item, index) => (
                <li key={index}>
                  <strong>{item.wallTypeName}</strong>: कुल घरधुरीको {localizeNumber(((item.households / totalHouseholds) * 100).toFixed(1), "ne")}% 
                  ({localizeNumber(item.households.toLocaleString(), "ne")} घरधुरी)
                </li>
              ))}
              <li>
                <strong>अन्य प्रकारका गारो</strong>: कुल घरधुरीको {localizeNumber(
                  ((overallSummary.slice(3).reduce((sum, item) => sum + item.households, 0) / totalHouseholds) * 100).toFixed(1),
                  "ne"
                )}% ({localizeNumber(
                  overallSummary.slice(3).reduce((sum, item) => sum + item.households, 0).toLocaleString(),
                  "ne"
                )} घरधुरी)
              </li>
            </ul>
            ...
            <p>
              गुणस्तरको आधारमा विश्लेषण गर्दा, {localizeNumber(
                ((overallSummary.find(i => i.wallType === "CEMENT_JOINED")?.households || 0) / totalHouseholds * 100).toFixed(1),
                "ne"
              )}% घरहरूमा सिमेन्टको जोडाइ भएको इँटा/ढुङ्गाको गारो छ, जुन उच्च गुणस्तर र बलियोपनको सूचक हो। यस्ता घरहरू मुख्यतया नगरिय क्षेत्र र बजार केन्द्रमा अवस्थित छन्।
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            <h2 id="outer-wall-quality-analysis" className="scroll-m-20 border-b pb-2">
              बाहिरी गारोको गुणस्तर विश्लेषण
            </h2>
            <p>
              घरको बाहिरी गारोको गुणस्तर विश्लेषणमा सिमेन्टको जोडाइ भएको इँटा/ढुङ्गा र प्रि फ्याब जस्ता गारोलाई उच्च गुणस्तरका, 
              माटोको जोडाइ भएको इँटा/ढुङ्गा र काठ/फल्याकलाई मध्यम गुणस्तरका र काँचो इँटा, जस्ता/टिन/च्यादर, बाँसजन्य सामग्री 
              र अन्य सामग्रीलाई न्यून गुणस्तरका रूपमा वर्गीकरण गरिएको छ।
            </p>
            
            <p>
              यस विश्लेषण अनुसार, पालिकाभरमा {localizeNumber(
                ((wardWiseAnalysis.reduce((sum, ward) => sum + ward.highQualityWalls, 0) / totalHouseholds) * 100).toFixed(1),
                "ne"
              )}% घरहरूमा उच्च गुणस्तरका गारो छन्, {localizeNumber(
                ((wardWiseAnalysis.reduce((sum, ward) => sum + ward.mediumQualityWalls, 0) / totalHouseholds) * 100).toFixed(1),
                "ne"
              )}% घरहरूमा मध्यम गुणस्तरका गारो छन्, र {localizeNumber(
                ((wardWiseAnalysis.reduce((sum, ward) => sum + ward.lowQualityWalls, 0) / totalHouseholds) * 100).toFixed(1),
                "ne"
            ...
            <p>
              खजुरा गाउँपालिकामा घरको बाहिरी गारोको वितरण विश्लेषणबाट निम्न निष्कर्ष र सिफारिसहरू गर्न सकिन्छ:
            </p>
            ...
            <div className="pl-6 space-y-4">
              <div className="flex">
                ...
                <div>
                  <strong>संरचनागत सुरक्षा सुधार:</strong> झण्डै {localizeNumber(
                    ((wardWiseAnalysis.reduce((sum, ward) => sum + ward.lowQualityWalls, 0) / totalHouseholds) * 100).toFixed(0),
                    "ne"
                  )}% घरहरूमा न्यून गुणस्तरका गारो रहेकाले यस्ता घरहरूको संरचनागत सुरक्षा सुधार गर्न आवश्यक कार्यक्रमहरू संचालन गर्नुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">२.</span>
                <div>
                  <strong>भवन निर्माण मापदण्ड कार्यान्वयन:</strong> नयाँ घरहरू निर्माण गर्दा भूकम्प प्रतिरोधी गारो प्रविधिहरू (सिमेन्टको जोडाइ भएको इँटा/ढुङ्गा वा प्रि फ्याब) अनिवार्य गर्ने नीति लागू गर्न सिफारिस गरिन्छ।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">३.</span>
                <div>
                  <strong>वडागत लक्षित कार्यक्रम:</strong> {wardWiseAnalysis.slice(-3).map((ward, i, arr) => (
                    i === arr.length - 1 
                      ? `र वडा नं. ${localizeNumber(ward.wardNumber.toString(), "ne")}` 
                      : `वडा नं. ${localizeNumber(ward.wardNumber.toString(), "ne")}, `
                  ))}
                  जस्ता वडाहरूमा न्यून गुणस्तरका गारो भएका घरहरू बढी भएकाले यी वडाहरूमा लक्षित कार्यक्रमहरू संचालन गर्नुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">४.</span>
                <div>
                  <strong>जनचेतना अभिवृद्धि:</strong> गारोको गुणस्तर र भूकम्पीय सुरक्षाका बारेमा घरधुरीहरूलाई सचेत गराउन जनचेतना अभिवृद्धि कार्यक्रमहरू संचालन गर्नुपर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">५.</span>
                <div>
                  <strong>स्थानीय निर्माण सामग्रीको गुणस्तर सुधार:</strong> स्थानीय रूपमा उत्पादित निर्माण सामग्रीहरू (जस्तै: इँटा, ब्लक) को गुणस्तर सुधार र प्रमाणीकरण प्रणाली विकास गर्नुपर्ने।
                </div>
              </div>
            </div>
            
            <p>
              खजुरा गाउँपालिकामा घरको बाहिरी गारोको समग्र अवस्था मध्यम स्तरको रहेको देखिन्छ। उच्च गुणस्तरका गारो भएका घरहरूको संख्या बढाउन र न्यून गुणस्तरका गारो भएका घरहरूको संरचनागत सुधार गर्न नीतिगत र कार्यक्रमगत पहलहरू आवश्यक छन्।
            </p>
          </div>
        </section>
      </div>
