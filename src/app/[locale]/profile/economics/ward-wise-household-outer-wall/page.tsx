...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका घरको बाहिरी गारो",
      "परिवर्तन घरको बाहिरी गारो वितरण",
      "वडा अनुसार घरको बाहिरी गारो",
      "घरको बाहिरी गारो विवरण",
      "सिमेन्टको जोडाइ भएको इँटा/ढुङ्गा",
      "माटोको जोडाइ भएको घरहरू",
      `परिवर्तन घरको बाहिरी गारो संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
      "परिवर्तन गृह सुरक्षा",
      "परिवर्तन आवास संरचना",
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality house outer wall",
      "pariwartan house outer wall distribution",
      "Ward-wise house outer wall",
      "House outer wall details",
      "Cement-bonded walls in pariwartan",
      "Mud-bonded wall households",
      `pariwartan household outer wall count ${totalHouseholds}`,
      "pariwartan housing safety",
      "pariwartan housing structure",
    ];
    ...
    return {
      title: "घरको बाहिरी गारोको वितरण | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरको बाहिरी गारोको वितरण - परिवर्तन गाउँपालिका (House Outer Wall Distribution - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा घरको बाहिरी गारोको वितरण
            </h1>
            ...
            <p>
              ...
              खण्डमा परिवर्तन गाउँपालिकामा घरको बाहिरी गारोका प्रमुख प्रकारहरू र
              तिनको वडागत वितरणको विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              परिवर्तन गाउँपालिकाको घरको बाहिरी गारोको तथ्याङ्क अनुसार, कुल
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरको बाहिरी गारोका प्रमुख प्रकारहरू र तिनको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरको बाहिरी गारोको वितरण विश्लेषणबाट निम्न
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरको बाहिरी गारोको समग्र अवस्था मध्यम स्तरको
