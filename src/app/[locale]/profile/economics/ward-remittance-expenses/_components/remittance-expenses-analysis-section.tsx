    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Remittance Expense Analysis of pariwartan
          </span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-medium mb-2">
              प्रमुख खर्च प्रकार
              <span className="sr-only">
                Main Expense Type in pariwartan Rural Municipality
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topExpense
                  ? `${((topExpense.households / totalHouseholds) * 100).toFixed(2)}% of households receiving remittances in pariwartan Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Primary to Secondary Expense Ratio in pariwartan
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topExpense && secondExpense
                  ? `For every ${topTwoExpenseRatio} households spending on ${EXPENSE_NAMES_EN[topExpense.expense]}, there is 1 household spending on ${EXPENSE_NAMES_EN[secondExpense.expense]} in pariwartan Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-2">
          थप जानकारी
          <span className="sr-only">
            Additional Information about Remittance Expenses in pariwartan
          </span>
        </h3>
        <p>
