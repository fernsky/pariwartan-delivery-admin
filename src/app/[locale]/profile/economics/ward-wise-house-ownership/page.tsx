...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality house ownership",
      "pariwartan house ownership distribution",
      "Ward-wise house ownership",
      "House ownership details",
      "Private house ownership in pariwartan",
      "Rented households count",
      `pariwartan household ownership count ${totalHouseholds}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घर स्वामित्वको वितरण - परिवर्तन गाउँपालिका (House Ownership Distribution - pariwartan Rural Municipality)"
