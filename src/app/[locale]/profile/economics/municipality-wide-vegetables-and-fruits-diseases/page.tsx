...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality vegetables fruits diseases pests",
      "pariwartan vegetable production problems",
      ...
      `pariwartan vegetable protection ${totalVegetableFruits} types`,
    ];
    ...
    const descriptionEN = `Analysis of diseases and pests affecting vegetables and fruits in pariwartan Rural Municipality. Detailed study of major diseases and pests affecting ${totalVegetableFruits} types of vegetables and fruits. Most affected crop is ${VEGETABLE_FRUIT_TYPES_EN[mostAffectedVegetableFruit] || mostAffectedVegetableFruit}. Municipality-wide vegetable and fruit protection planning and strategy analysis.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तरकारी र फलफूलमा रोग कीटपतंग - परिवर्तन गाउँपालिका (Vegetable and Fruit Diseases and Pests - pariwartan Rural Municipality)"
