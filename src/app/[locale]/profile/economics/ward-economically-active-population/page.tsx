...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality economically active population",
      "pariwartan ward-wise economic demographics",
      "Demographic classification pariwartan",
      "Working age group",
      "Gender-wise economic population",
      "Economic activity analysis",
      "15-59 age group population",
      `pariwartan total economically active population ${totalPopulation}`,
    ];
    ...
    const descriptionEN = `Ward-wise economically active population distribution, age and gender classification, and analysis for pariwartan Rural Municipality. Out of a total ${totalPopulation} population, the working-age group (15-59 years) comprises ${workingAgePopulation} people (${workingAgePercentage}%). Gender distribution shows ${GENDER_NAMES_EN["MALE"]} ${genderCounts["MALE"] || 0}, ${GENDER_NAMES_EN["FEMALE"]} ${genderCounts["FEMALE"] || 0}, and ${GENDER_NAMES_EN["OTHER"]} ${genderCounts["OTHER"] || 0}. Includes detailed statistics and visualizations.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="आर्थिक रूपमा सक्रिय जनसंख्या - परिवर्तन गाउँपालिका (Economically Active Population - pariwartan Rural Municipality)"
