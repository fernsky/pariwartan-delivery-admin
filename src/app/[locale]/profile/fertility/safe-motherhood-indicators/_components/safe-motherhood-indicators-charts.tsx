  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Safe Motherhood Trends in pariwartan Rural Municipality"
        />
        <meta
      ...
      >
        <meta
          itemProp="name"
          content={`Antenatal Care Indicators in pariwartan for ${latestYear}`}
        />
        <meta
          itemProp="description"
      ...
      >
        <meta
          itemProp="name"
          content={`Delivery Services in pariwartan for ${latestYear}`}
        />
        <meta
          itemProp="description"
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <meta
            itemProp="name"
            content="Postnatal Care Indicators in pariwartan"
          />
        ...
        >
          <meta
            itemProp="name"
            content="Newborn Health Indicators in pariwartan"
          />
