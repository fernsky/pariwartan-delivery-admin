...
export default function WardWiseDrinkingWaterSourceAnalysisSection({
  ...
  const waterQualityLevel = 
    waterQualityIndex >= 85 ? "उत्तम (Excellent)" :
    waterQualityIndex >= 70 ? "राम्रो (Good)" :
    waterQualityIndex >= 50 ? "मध्यम (Average)" :
    "निम्न (Poor)";
  ...
  const seoAttributes = {
    ...
    "data-highest-piped-water-ward": highestPipedWaterWard?.wardNumber.toString() || "",
    "data-lowest-piped-water-ward": lowestPipedWaterWard?.wardNumber.toString() || "",
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            {highestPipedWaterWard && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(highestPipedWaterWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    पाइपको पानी प्रयोग गर्ने दर: {localizeNumber(highestPipedWaterWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
                      {highestPipedWaterWard.percentage.toFixed(2)}% piped water usage rate
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 space-y-2">
                <p className="text-sm">
                  यस वडामा पाइपको पानी प्रयोग गर्ने घरधुरीहरूको प्रतिशत सबैभन्दा बढी रहेको छ, जुन पालिकाको औसतभन्दा {localizeNumber((highestPipedWaterWard.percentage - waterSourceGroupPercentages.PIPED_WATER).toFixed(2), "ne")}% ले उच्च छ।
                </p>
                <p className="text-sm">
                  यसले यस वडामा खानेपानी आपूर्ति प्रणालीको विकास तथा पूर्वाधारमा गरिएको लगानी प्रभावकारी रहेको संकेत गर्दछ।
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">Ward with Low Piped Water Use in Khajura</span>
            </h4>
            {lowestPipedWaterWard && (
              <div className="flex items-center gap-3">
                <div
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(lowestPipedWaterWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    पाइपको पानी प्रयोग गर्ने दर: {localizeNumber(lowestPipedWaterWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
                      {lowestPipedWaterWard.percentage.toFixed(2)}% piped water usage rate
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 p-3 bg-amber-50 rounded-lg border border-amber-100">
                <p className="text-sm">
                  यस वडामा पाइपको पानी प्रयोग गर्ने घरधुरीहरूको दर न्यून रहेकाले यस वडामा खानेपानी पूर्वाधारमा प्राथमिकताका साथ लगानी गरी पाइप प्रणाली विस्तार गर्नुपर्ने आवश्यकता देखिन्छ।
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            ...
            <div className="space-y-3 text-sm">
              <p className="flex gap-2">
                ...
                <span>
                  <strong>सूचकाङ्क विवरण:</strong> खानेपानी गुणस्तर सूचकाङ्क विभिन्न स्रोतहरूको भारित औसतमा आधारित छ, जसमा पाइपको पानी र ट्युबवेलको पानीलाई बढी भार दिइएको छ।
                </span>
              </p>
              <p className="flex gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  <strong>व्याख्या:</strong> {localizeNumber((waterQualityIndex).toFixed(1), "ne")} अंकले {waterQualityLevel} खानेपानी गुणस्तर दर्शाउँछ। यसमा सुधारका लागि खानेपानी शोधन र सुरक्षित पानी आपूर्ति व्यवस्था सुदृढ गर्नुपर्छ।
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div>
              <h5 className="text-sm font-medium">सबैभन्दा बढी प्रयोग हुने स्रोतहरू</h5>
              <div className="mt-2 space-y-3">
                {Object.entries(waterSourceTotals)
                  ...
                  .map(([source, count], index) => {
                    ...
                    for (const [key, group] of Object.entries(WATER_SOURCE_GROUPS)) {
                ...
                <div className="flex justify-between text-sm">
                  <span>
                    <span 
                      ...
                      style={{ backgroundColor: WATER_SOURCE_GROUPS.PIPED_WATER.color }}
                    ></span>
                    पाइपको पानी
                  </span>
                  <span className="font-medium">
                    {localizeNumber(waterSourceGroupPercentages.PIPED_WATER.toFixed(2), "ne")}%
                  </span>
                </div>
                <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                  <div
