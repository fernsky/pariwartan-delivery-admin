    ...
    <>
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        <h3 className="text-xl font-medium mb-6">
          ...
          <span className="sr-only">
            Detailed Solid Waste Management Analysis of pariwartan
          </span>
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Ward with Highest Home Waste Collection in pariwartan Rural
                Municipality
              </span>
            </h4>
            {highestHomeCollectionWard && (
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Ward with Low Home Waste Collection in pariwartan
              </span>
            </h4>
            {lowestHomeCollectionWard && (
              <div className="flex items-center gap-3">
