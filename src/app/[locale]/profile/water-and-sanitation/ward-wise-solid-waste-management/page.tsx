...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality solid waste management",
    ...
    const descriptionEN = `Ward-wise analysis of solid waste management in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${homeCollectionPercentage}% (${homeCollectionHouseholds.toLocaleString()}) households use home waste collection methods.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="फोहोरमैला व्यवस्थापन - परिवर्तन गाउँपालिका (Solid Waste Management - pariwartan Rural Municipality)"
