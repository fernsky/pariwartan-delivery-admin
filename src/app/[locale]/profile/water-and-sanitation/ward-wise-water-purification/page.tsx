...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const mostCommonTypeName = waterPurificationOptions.find(option => option.value === mostCommonType)?.label.split(" (")[0] || mostCommonType;
    ...
    const keywordsNP = [
      "खजुरा गाउँपालिका पानी शुद्धिकरण",
      "वडागत पानी शुद्धिकरण अभ्यास",
      "पानी उमाल्ने परिवार संख्या",
      "पानी फिल्टर प्रयोग दर",
      "पियूष प्रयोग गर्ने घरधुरी",
      `खजुरा पानी शुद्धिकरण तथ्याङ्क ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];
    ...
    const descriptionNP = `खजुरा गाउँपालिकामा वडा अनुसार पानी शुद्धिकरण विधिहरूको वितरण र विश्लेषण। कुल घरधुरी संख्या ${localizeNumber(totalHouseholds.toString(), "ne")} मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ले ${mostCommonTypeName} विधि प्रयोग गर्दछन्। विभिन्न वडाहरूमा पानी शुद्धिकरण विधिहरूको विस्तृत विश्लेषण।`;
    ...
    return {
      title: "पानी शुद्धिकरण विधिहरू | खजुरा गाउँपालिका डिजिटल प्रोफाइल",
...
const toc = [
  ...
  { level: 2, text: "पानी शुद्धिकरण विधिहरू", slug: "water-purification-methods" },
  { level: 2, text: "वडा अनुसार पानी शुद्धिकरण अभ्यास", slug: "ward-wise-water-purification" },
  { level: 2, text: "पानी शुद्धिकरण विश्लेषण", slug: "water-purification-analysis" },
...
export default async function WardWiseWaterPurificationPage() {
  ...
  const pieChartData = overallSummary.map((item) => ({
    ...
    color: WATER_PURIFICATION_COLORS[item.waterPurification as keyof typeof WATER_PURIFICATION_COLORS] || "#888888",
  }));
  ...
  const wardWiseData = wardNumbers.map((wardNumber) => {
    ...
    wardData.forEach((item) => {
      result[methodMap[item.waterPurification] || item.waterPurification] = item.households;
    ...
    result.total = wardData.reduce((sum, item) => sum + (item.households || 0), 0);
  ...
  const wardWiseAnalysis = wardNumbers.map((wardNumber) => {
    ...
    const mostCommonMethod = wardData.reduce((prev, current) => {
    ...
    const treatingPercentage = wardTotalHouseholds > 0 
    ...
    wardData.forEach(item => {
      methodPercentages[item.waterPurification] = wardTotalHouseholds > 0 
    ...
    return {
      ...
      mostCommonMethodName: methodMap[mostCommonMethod.waterPurification] || mostCommonMethod.waterPurification,
      mostCommonMethodHouseholds: mostCommonMethod.households || 0,
      mostCommonMethodPercentage: wardTotalHouseholds > 0 
        ? ((mostCommonMethod.households || 0) / wardTotalHouseholds * 100).toFixed(2)
        : "0",
      treatingHouseholds,
      treatingPercentage,
      methodPercentages,
  ...
  const sortedByTreatmentRate = [...wardWiseAnalysis].sort(
    (a, b) => parseFloat(b.treatingPercentage) - parseFloat(a.treatingPercentage)
  );
  
  const highestTreatmentWard = sortedByTreatmentRate[0];
  const lowestTreatmentWard = sortedByTreatmentRate[sortedByTreatmentRate.length - 1];
  ...
  overallSummary.forEach(item => {
    safetyIndex += (item.households / totalHouseholds) * 
      (safetyWeight[item.waterPurification as keyof typeof safetyWeight] || 0.5) * 100;
  });
  
  // Generate water safety rating based on index
  const waterSafetyRating = 
    safetyIndex >= 75 ? "उत्तम (Excellent)" :
    safetyIndex >= 60 ? "राम्रो (Good)" :
    safetyIndex >= 40 ? "मध्यम (Average)" :
    "निम्न (Poor)";
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="पानी शुद्धिकरण विधिहरू - खजुरा गाउँपालिका (Water Purification Methods - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              पानी शुद्धिकरण स्वस्थ जीवनयापनको एक महत्वपूर्ण पक्ष हो। यसले जलजन्य रोगहरूबाट बच्न र समग्र जनस्वास्थ्य सुधार गर्न मद्दत गर्छ। 
              यस खण्डमा खजुरा गाउँपालिकाका विभिन्न वडाहरूमा प्रयोग गरिने पानी शुद्धिकरण विधिहरूको वितरण र विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              खजुरा गाउँपालिकामा कुल {localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये  
              {overallSummary[0] && ` सबैभन्दा धेरै ${overallSummary[0]?.waterPurificationName} विधि 
              ${localizeNumber(((overallSummary[0]?.households || 0) / totalHouseholds * 100).toFixed(1), "ne")}% घरधुरीले`} 
              प्रयोग गर्दछन्। यस अध्ययनले पानी शुद्धिकरणको अभ्यासहरू र सुधारका क्षेत्रहरू पहिचान गर्न मद्दत गर्नेछ।
            </p>
            ...
            <p>
              खजुरा गाउँपालिकामा पानी शुद्धिकरणका प्रमुख विधिहरू र तिनको प्रयोग निम्नानुसार
              रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            <h2 id="water-purification-analysis" className="scroll-m-20 border-b pb-2">
              पानी शुद्धिकरण विश्लेषण
            </h2>
            <p>
              खजुरा गाउँपालिकामा पानी शुद्धिकरण विधिहरूको विश्लेषण गर्दा, 
              {overallSummary[0]?.waterPurificationName || ''} विधि सबैभन्दा बढी 
              {overallSummary[0] ? ` ${localizeNumber(((overallSummary[0]?.households || 0) / totalHouseholds * 100).toFixed(2), "ne")}% ` : ' '}
              घरधुरीमा प्रयोग भएको पाइन्छ। पानी शुद्धिकरण नगर्ने घरधुरीहरुको संख्या 
              {
                (() => {
                  const noFilteringData = overallSummary.find(item => item.waterPurification === 'NO_ANY_FILTERING');
            ...
            <h2 id="recommendations-for-improvement" className="scroll-m-20 border-b pb-2 mt-12">
            ...
            <div className="pl-6 space-y-4">
              <div className="flex">
                ...
                <div>
                  ...
                  मा पानी शुद्धिकरणको महत्त्वबारे जनचेतना कार्यक्रम सञ्चालन गर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">२.</span>
                <div>
                  <strong>खानेपानी परीक्षण सेवा:</strong> घरधुरी स्तरमा पानीको गुणस्तर
                  परीक्षण सेवा उपलब्ध गराई प्रदूषित स्रोतहरू पहिचान गर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">३.</span>
                <div>
                  <strong>फिल्टर वितरण कार्यक्रम:</strong> आर्थिक रूपमा कमजोर परिवारहरूलाई
                  सस्तो र दिगो पानी फिल्टरहरू वितरण गर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">४.</span>
                <div>
                  <strong>पियूष वितरण र प्रशिक्षण:</strong> पियूष जस्ता रासायनिक शुद्धिकरण विधिहरू प्रयोग गर्ने 
                  तरिकाबारे प्रशिक्षण र आवश्यक सामग्री वितरण गर्ने।
                </div>
              </div>
              <div className="flex">
                <span className="font-bold mr-2">५.</span>
                <div>
                  <strong>समुदायमा आधारित अनुगमन प्रणाली:</strong> प्रत्येक वडामा पानी शुद्धिकरण
                  अभ्यासहरूको अनुगमन र प्रोत्साहन गर्न समुदायमा आधारित प्रणाली स्थापना गर्ने।
                </div>
              </div>
            </div>

            <p className="mt-6">
              यी सिफारिसहरू कार्यान्वयन गरेर, खजुरा गाउँपालिकामा पानी शुद्धिकरणको अवस्थामा उल्लेखनीय सुधार ल्याउन
              सकिन्छ, जसले जनस्वास्थ्य सुधार र जलजन्य रोगहरू न्यूनीकरणमा महत्त्वपूर्ण योगदान पुर्याउनेछ।
            </p>
          </div>
        </section>
      </div>
