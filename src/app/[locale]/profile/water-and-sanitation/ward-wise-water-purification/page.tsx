...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका पानी शुद्धिकरण",
      "वडागत पानी शुद्धिकरण अभ्यास",
      "पानी उमाल्ने परिवार संख्या",
      "पानी फिल्टर प्रयोग दर",
      "पियूष प्रयोग गर्ने घरधुरी",
      `परिवर्तन पानी शुद्धिकरण तथ्याङ्क ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];

    const keywordsEN = [
      "pariwartan Rural Municipality water purification",
      ...
      `pariwartan water purification data ${totalHouseholds}`,
    ];
    ...
    const descriptionEN = `Ward-wise distribution and analysis of water purification methods in pariwartan Rural Municipality. Out of a total of ${totalHouseholds} households, ${mostCommonPercentage}% (${mostCommonCount}) use ${mostCommonTypeName} method. Detailed analysis of water purification methods across various wards.`;
    ...
    return {
      title: "पानी शुद्धिकरण विधिहरू | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="पानी शुद्धिकरण विधिहरू - परिवर्तन गाउँपालिका (Water Purification Methods - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा पानी शुद्धिकरणको अवस्था
            </h1>
            ...
            <p>
              ...
              यस खण्डमा परिवर्तन गाउँपालिकाका विभिन्न वडाहरूमा प्रयोग गरिने पानी
            ...
            <p>
              परिवर्तन गाउँपालिकामा पानी शुद्धिकरणका प्रमुख विधिहरू र तिनको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा पानी शुद्धिकरण विधिहरूको विश्लेषण गर्दा,
            ...
            <p>
              परिवर्तन गाउँपालिकामा पानी शुद्धिकरण अभ्यासहरू सुधार गर्न निम्न
            ...
            <p className="mt-6">
              यी सिफारिसहरू कार्यान्वयन गरेर, परिवर्तन गाउँपालिकामा पानी
