  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Water Purification Methods in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Water purification method distribution of pariwartan with a total of ${totalHouseholds} households`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Water Purification in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Water purification methods distribution across wards in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Water Treatment Rate Comparison Across Wards in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Comparison of water treatment rates across wards in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Water Purification Analysis in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Most common water purification methods by ward in pariwartan"
        />
