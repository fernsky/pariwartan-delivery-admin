...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionEN = `Ward-wise distribution and analysis of toilet types in pariwartan Rural Municipality. Out of a total of ${totalHouseholds} households, ${mostCommonPercentage}% (${mostCommonCount}) use ${mostCommonTypeName}. Detailed analysis of toilet types across various wards.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="शौचालय प्रकारहरू - परिवर्तन गाउँपालिका (Toilet Types - pariwartan Rural Municipality)"
