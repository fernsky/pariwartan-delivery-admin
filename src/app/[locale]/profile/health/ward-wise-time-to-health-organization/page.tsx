...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality healthcare access",
    ...
    const descriptionEN = `Analysis of time taken to reach healthcare facilities in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${under15MinPercentage}% (${under15MinHouseholds.toLocaleString()}) can reach a health facility within 15 minutes.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="स्वास्थ्य संस्था पुग्न लाग्ने समय - परिवर्तन गाउँपालिका (Time to Health Organization - pariwartan Rural Municipality)"
