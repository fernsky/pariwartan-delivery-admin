  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content={`Immunization Coverage Rates in pariwartan for ${fiscalYearLabels[currentFiscalYear]}`}
        />
        <meta
      ...
      >
        <meta
          itemProp="name"
          content="Immunization Coverage Trends in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <meta
            itemProp="name"
            content="Immunization Session Indicators in pariwartan"
          />
        ...
        >
          <meta
            itemProp="name"
            content="Immunization Coverage for Pregnant Women in pariwartan"
          />
      ...
      >
        <meta
          itemProp="name"
          content="Vaccine Dropout Rates in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
      ...
      >
        <meta
          itemProp="name"
          content="Vaccine Wastage Rates in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
