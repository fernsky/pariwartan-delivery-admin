...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality immunization coverage",
      ...
      "Vaccination services in pariwartan",
    ...
    const descriptionEN = `Analysis of basic immunization services in pariwartan Rural Municipality. In fiscal year ${fiscalYearLabel}, full immunization coverage was ${fullyImmunizedCoverage.toFixed(1)}%, DPT-HepB-Hib3 coverage was ${dptHib3Coverage.toFixed(1)}%, and measles-rubella coverage was ${measlesRubella1Coverage.toFixed(1)}%.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खोप सेवा र कभरेज - परिवर्तन गाउँपालिका (Immunization Services and Coverage - pariwartan Rural Municipality)"
