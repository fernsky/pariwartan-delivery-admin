...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality health insurance",
    ...
    const descriptionEN = `Analysis of health insurance coverage in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${insuredPercentage}% (${totalInsuredHouseholds.toLocaleString()}) households have health insurance.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="स्वास्थ्य बीमा गरेका घरधुरीको अवस्था - परिवर्तन गाउँपालिका (Health Insured Households - pariwartan Rural Municipality)"
