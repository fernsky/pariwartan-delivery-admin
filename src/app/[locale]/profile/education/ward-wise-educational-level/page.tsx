...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality educational level",
    ...
    const descriptionEN = `Analysis of educational levels in pariwartan Rural Municipality. Out of a total of ${totalPopulation.toLocaleString()} people, ${highestEducationPercentage}% (${highestEducationCount.toLocaleString()}) have attained higher education.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="शैक्षिक स्तरको अवस्था - परिवर्तन गाउँपालिका (Educational Level Status - pariwartan Rural Municipality)"
