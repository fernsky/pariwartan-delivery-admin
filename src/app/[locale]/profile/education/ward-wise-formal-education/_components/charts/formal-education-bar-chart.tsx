...
interface FormalEducationBarChartProps {
...
export default function FormalEducationBarChart({
  wardWiseData,
  FORMAL_EDUCATION_GROUPS,
}: FormalEducationBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(FORMAL_EDUCATION_GROUPS).map((group, index, arr) => (
          <Bar
            key={group.name}
            dataKey={group.name}
            name={group.name}
