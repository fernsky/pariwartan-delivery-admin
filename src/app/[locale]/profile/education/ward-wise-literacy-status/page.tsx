...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका साक्षरता दर",
      "साक्षरताको अवस्था",
      "वडागत साक्षरता",
      "पढ्न लेख्न जान्ने",
      "शैक्षिक स्थिति",
    ...
    const keywordsEN = [
      "Paribartan Rural Municipality literacy rate",
      "Literacy status",
      "Ward-wise literacy",
    ...
    return {
      title: "साक्षरताको अवस्था | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="साक्षरताको अवस्था - परिवर्तन गाउँपालिका (Literacy Status - Paribartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा साक्षरताको अवस्था
            </h1>
            ...
            <p>
              ...
              पुर्‍याउँछ। यस खण्डमा परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा
            ...
            <p>
              परिवर्तन गाउँपालिकामा साक्षरताको अवस्थाको वितरण निम्नानुसार रहेको
              छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा साक्षरताको अवस्थाको विश्लेषण गर्दा, समग्रमा
              {localizeNumber(
            ...
            <p>
              परिवर्तन गाउँपालिकामा साक्षरताको अवस्थाको तथ्याङ्क विश्लेषणबाट
            ...
            <p className="mt-6">
              यसरी परिवर्तन गाउँपालिकामा साक्षरताको अवस्थाको विश्लेषणले पालिकामा
