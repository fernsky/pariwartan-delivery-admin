...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality school dropout causes",
      "School dropout rate",
    ...
    const descriptionEN = `Analysis of school dropout causes in pariwartan Rural Municipality. Out of a total of ${totalDropouts.toLocaleString()} dropouts, ${economicDropoutPercentage}% (${economicDropouts.toLocaleString()}) have left school for economic reasons.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="विद्यालय छाड्ने कारणहरू - परिवर्तन गाउँपालिका (School Dropout Causes - pariwartan Rural Municipality)"
