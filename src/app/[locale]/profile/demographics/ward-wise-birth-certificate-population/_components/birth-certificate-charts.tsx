  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Birth Certificate Status for Children Under 5 Years in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Birth certificate distribution of children under 5 years in pariwartan showing both with and without certificates`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Birth Certificate Coverage in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Ward-wise coverage rates of birth certificates for children under 5 years in pariwartan"
        />
