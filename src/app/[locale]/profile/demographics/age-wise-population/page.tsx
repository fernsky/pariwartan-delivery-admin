...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality age distribution",
      "pariwartan age demographics",
      `pariwartan children population ${childrenPct}%`,
      `pariwartan youth population ${youthPct}%`,
    ...
    const descriptionEN = `Ward-wise age group population distribution, trends and analysis for pariwartan Rural Municipality. Out of a total population of ${totalPopulation}, children make up ${childrenPct}% and youth make up ${youthPct}%. Detailed statistics and visualizations of various age groups.`;
