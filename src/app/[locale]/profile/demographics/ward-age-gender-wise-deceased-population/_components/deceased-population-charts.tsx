  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Gender-wise Deceased Population in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Gender-wise distribution of deceased population in pariwartan with a total of ${totalDeceasedPopulation}`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Age Group-wise Deceased Population in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Distribution of deceased population by age groups in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Deceased Population in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Distribution of deceased population across wards in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Age-Gender Mortality Analysis in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Detailed age and gender mortality distribution by ward in pariwartan"
        />
