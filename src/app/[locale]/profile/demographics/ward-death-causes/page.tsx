...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality causes of death",
      "pariwartan mortality analysis",
      `pariwartan ${DEATH_CAUSE_NAMES_EN[topDeathCauses[0] as DeathCauseType]} deaths`,
      ...topDeathCauses.map(
        (r) =>
          `${DEATH_CAUSE_NAMES_EN[r as DeathCauseType]} deaths in pariwartan`,
      ),
      "Ward-wise death cause distribution",
      "Health statistics pariwartan",
      "Mortality survey pariwartan",
      `pariwartan total deaths ${totalDeaths}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="मृत्युका प्रमुख कारणहरू - परिवर्तन गाउँपालिका (Main Causes of Death - pariwartan Rural Municipality)"
