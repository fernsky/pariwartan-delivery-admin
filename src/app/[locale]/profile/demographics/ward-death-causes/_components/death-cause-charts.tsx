  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Death Cause Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Distribution of death causes in pariwartan with a total of ${totalDeaths} deaths`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Death Cause Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Death cause distribution across wards in pariwartan"
        />
      ...
      >
        <meta
          itemProp="name"
          content="Detailed Death Cause Analysis by Ward in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Detailed death cause composition of each ward in pariwartan"
        />
