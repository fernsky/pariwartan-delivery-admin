...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality birthplace households",
      "pariwartan household birthplace distribution",
      "Ward-wise birthplace data",
      "Household birthplace analysis",
      "Local households in pariwartan",
      "Inter-district migration",
      `pariwartan total households ${totalPopulation}`,
    ];
    ...
    const descriptionEN = `Age-group-wise distribution and analysis of birthplaces in pariwartan Rural Municipality. Total population is ${totalPopulation}. Detailed analysis of birthplaces across various age groups.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरपरिवारको जन्मस्थान - परिवर्तन गाउँपालिका (Household Birthplaces - pariwartan Rural Municipality)"
