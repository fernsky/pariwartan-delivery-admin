...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality religious population",
      "pariwartan religious diversity",
      `pariwartan ${RELIGION_NAMES_EN[topReligions[0]]} population`,
      ...topReligions.map(
        (r) => `${RELIGION_NAMES_EN[r]} population in pariwartan`,
      ),
      "Religious diversity statistics",
      "Religious census pariwartan",
    ...
    const descriptionEN = `Religious population distribution, trends and analysis for pariwartan Rural Municipality. Out of a total population of ${totalPopulation}, ${RELIGION_NAMES_EN[topReligions[0]]} (${religionCounts[topReligions[0]]}) is the largest group, followed by ${RELIGION_NAMES_EN[topReligions[1]]} (${religionCounts[topReligions[1]]}) and ${RELIGION_NAMES_EN[topReligions[2]]} (${religionCounts[topReligions[2]]})। Detailed statistics and visualizations of various religious communities.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="धार्मिक विविधता - परिवर्तन गाउँपालिका (Religious Diversity - pariwartan Rural Municipality)"
