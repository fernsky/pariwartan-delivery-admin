    ...
    <>
      ...
      <section id="occupation-distribution">
        ...
        >
          <meta
            itemProp="name"
            content="Occupation Distribution in pariwartan Rural Municipality"
          />
          <meta
            itemProp="description"
            content={`Occupational composition of pariwartan with a total population of ${totalPopulation}`}
          />
      ...
      <section id="age-occupation-distribution">
        ...
        >
          <meta
            itemProp="name"
            content="Age-wise Occupation Distribution in pariwartan Rural Municipality"
          />
          <meta
            itemProp="description"
            content="Age group-wise occupation distribution in pariwartan"
          />
      ...
      <section>
        ...
        >
          <meta
            itemProp="name"
            content="Occupation Comparison in pariwartan Rural Municipality"
          />
          <meta
            itemProp="description"
