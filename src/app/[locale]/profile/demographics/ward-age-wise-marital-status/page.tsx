...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका वैवाहिक जनसंख्या",
      "परिवर्तन वैवाहिक स्थिति",
      `परिवर्तन ${MARITAL_STATUS_NAMES_NP[topMaritalStatuses[0]]} जनसंख्या`,
      ...topMaritalStatuses.map(
        (r) => `${MARITAL_STATUS_NAMES_NP[r]} जनसंख्या परिवर्तन`,
      ),
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality marital status population",
      "pariwartan marital status",
      `pariwartan ${MARITAL_STATUS_NAMES_EN[topMaritalStatuses[0]]} population`,
      ...topMaritalStatuses.map(
        (r) => `${MARITAL_STATUS_NAMES_EN[r]} population in pariwartan`,
      ),
      "Ward-wise marital status demographics",
      "Age-wise marital status statistics",
      "Marital status census pariwartan",
      `pariwartan total population ${totalPopulation}`,
    ];
    ...
    const descriptionEN = `Ward-wise and age-wise marital status distribution, trends and analysis for pariwartan Rural Municipality. Out of a total population of ${totalPopulation}, ${MARITAL_STATUS_NAMES_EN[topMaritalStatuses[0]]} (${maritalCounts[topMaritalStatuses[0]]}) is the largest group, followed by ${MARITAL_STATUS_NAMES_EN[topMaritalStatuses[1]]} (${maritalCounts[topMaritalStatuses[1]]}) and ${MARITAL_STATUS_NAMES_EN[topMaritalStatuses[2]]} (${maritalCounts[topMaritalStatuses[2]]})। Detailed statistics and visualizations of various marital status groups by age.`;
    ...
    return {
      title: "उमेर अनुसार वैवाहिक स्थिति | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="उमेर अनुसार वैवाहिक स्थिति - परिवर्तन गाउँपालिका (Age-wise Marital Status - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा उमेर अनुसार वैवाहिक स्थिति
            </h1>
            ...
            <p>
              परिवर्तन गाउँपालिकामा विभिन्न उमेर समूहका व्यक्तिहरूको वैवाहिक
            ...
            <p>
              परिवर्तन गाउँपालिकामा विभिन्न वैवाहिक स्थितिमा रहेका व्यक्तिहरूको
