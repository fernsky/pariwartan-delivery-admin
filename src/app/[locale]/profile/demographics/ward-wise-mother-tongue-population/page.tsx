...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality mother tongue population",
      "pariwartan linguistic diversity",
      `pariwartan ${LANGUAGE_NAMES_EN[topLanguages[0]]} speakers population`,
      ...topLanguages.map(
        (l) => `${LANGUAGE_NAMES_EN[l]} speakers in pariwartan`,
      ),
      "Ward-wise mother tongue demographics",
      "Linguistic diversity statistics",
      "Language census pariwartan",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="भाषिक विविधता - परिवर्तन गाउँपालिका (Linguistic Diversity - pariwartan Rural Municipality)"
