    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Linguistic Diversity Analysis of pariwartan
          </span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-medium mb-2">
              प्रमुख मातृभाषा
              <span className="sr-only">
                Main Mother Tongue in pariwartan Rural Municipality
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topLanguage
                  ? `${((topLanguage.population / totalPopulation) * 100).toFixed(2)}% of total population in pariwartan Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Primary to Secondary Language Ratio in pariwartan
              </span>
            </h4>
            <p className="text-3xl font-bold">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topLanguage && secondLanguage
                  ? `For every ${topTwoLanguageRatio} ${topLanguage.language.toLowerCase()} speakers, there is 1 ${secondLanguage.language.toLowerCase()} speaker in pariwartan Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
