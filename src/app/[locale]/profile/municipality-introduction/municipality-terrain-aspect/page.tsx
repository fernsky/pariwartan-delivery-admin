...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionEN = `Area distribution by aspect (direction) and geographical analysis of pariwartan Rural Municipality. Out of total area ${totalArea} sq. km., ${highestAspect.area_percentage.toFixed(1)}% faces ${highestAspect.direction_english} direction.`;
    ...
    return {
      ...
      keywords: [
        ...
        "परिवर्तन दिशा विवरण",
        "pariwartan aspect information",
        "Municipality directional data",
        "Aspect analysis Nepal",
        "Terrain aspect pariwartan",
