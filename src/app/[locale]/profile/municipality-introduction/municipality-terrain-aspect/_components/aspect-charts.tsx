  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Aspect Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Area distribution by aspect in pariwartan with a total area of ${aspectData.total.area_sq_km} sq. km.`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Aspect Area Distribution Chart in pariwartan Rural Municipality"
        />
