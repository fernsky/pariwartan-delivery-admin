...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality settlement distribution",
      "pariwartan ward settlements",
      `pariwartan total ${totalSettlements} settlements`,
    ...
    const descriptionEN = `Ward-wise settlement distribution and details for pariwartan Rural Municipality. Total ${totalSettlements} settlements are spread across ${settlementData.metadata.total_wards} wards. Ward ${wardWithMostSettlements.ward_number_english} has the highest number of settlements with ${wardWithMostSettlements.settlements.length} settlements. Comprehensive data on local communities and geographical areas.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वडागत बस्ती वितरण - परिवर्तन गाउँपालिका (Ward-wise Settlement Distribution - pariwartan Rural Municipality)"
