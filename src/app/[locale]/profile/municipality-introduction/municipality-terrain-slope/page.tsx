...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionEN = `Slope information and geographical analysis of pariwartan Rural Municipality. Out of total area ${totalArea} sq. km., ${gentleSlope ? gentleSlope.area_percentage.toFixed(1) : "75.7"}% has gentle slope (0-5 degrees).`;
    ...
    return {
      ...
      keywords: [
        ...
        "pariwartan slope information",
        "Municipality geographical data",
        "Slope analysis Nepal",
        "Terrain data pariwartan",
