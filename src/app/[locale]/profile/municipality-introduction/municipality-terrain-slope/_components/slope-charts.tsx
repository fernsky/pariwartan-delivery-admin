  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Slope Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Slope composition of pariwartan with a total area of ${slopeData.total.total_area_sq_km} sq. km.`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Slope Area Distribution Chart in pariwartan Rural Municipality"
        />
