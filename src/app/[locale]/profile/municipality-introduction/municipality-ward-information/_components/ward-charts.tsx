  ...
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Ward Demographics in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Ward-wise population and area distribution in pariwartan with ${wardData.totalWards} wards, total population ${wardData.totalPopulation}, and total area ${wardData.totalAreaSqKm} sq. km.`}
        />
      ...
      >
        <meta
          itemProp="name"
          content="Ward Demographics Comparison Chart in pariwartan Rural Municipality"
        />
