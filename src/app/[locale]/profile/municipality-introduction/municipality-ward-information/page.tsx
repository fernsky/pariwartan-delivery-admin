...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionEN = `Ward-wise population and area distribution of pariwartan Rural Municipality. Total ${totalWards} wards with ${totalPopulation} population and ${totalArea} sq. km. area.`;
    ...
    return {
      ...
      keywords: [
        ...
        "pariwartan ward information",
        "Municipality ward data",
        "Population statistics Nepal",
        "Ward demographics pariwartan",
