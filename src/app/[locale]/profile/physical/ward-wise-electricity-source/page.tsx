...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality electricity source",
    ...
    const descriptionEN = `Analysis of electricity source usage in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${mainGridPercentage}% use central electricity grid and ${solarPercentage}% use solar energy.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="विद्युतको स्रोतको प्रयोगको अवस्था - परिवर्तन गाउँपालिका (Electricity Source Usage - pariwartan Rural Municipality)"
