...
export default function WardWiseElectricitySourceAnalysisSection({
  ...
  const electricityAccessLevel = 
    electricityAccessIndex >= 75 ? "उच्च" :
    electricityAccessIndex >= 50 ? "राम्रो" :
    electricityAccessIndex >= 30 ? "मध्यम" :
    "न्यून";
  ...
  const traditionalSourcePercentage = ((traditionalSourceTotal / totalHouseholds) * 100).toFixed(2);
  ...
  return (
    <>
      ...
      >
        ...
        {Object.entries(ELECTRICITY_SOURCE_CATEGORIES).map(([categoryKey, category]) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Ward with Best Modern Electricity Source Usage in Khajura Rural Municipality
              </span>
            </h4>
            {bestWard && (
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    backgroundColor: ELECTRICITY_SOURCE_CATEGORIES.ELECTRICITY.color,
                  }}
                ></div>
                <div>
                  <p className="text-2xl font-bold">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    आधुनिक विद्युत स्रोत प्रयोग: {localizeNumber(bestWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
                      {bestWard.percentage.toFixed(2)}% modern electricity source usage
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 space-y-2">
                <p className="text-sm">
                  यस वडामा आधुनिक विद्युत स्रोत (केन्द्रीय विद्युत प्रणाली, सौर्य ऊर्जा) को प्रयोग उच्च छ, जुन पालिकाको औसतभन्दा {localizeNumber((bestWard.percentage - modernSourcePercentage).toFixed(2), "ne")}% ले बढी छ।
                </p>
                <p className="text-sm">
                  यसले यस वडाको विद्युत पूर्वाधार राम्रो भएको र वैकल्पिक ऊर्जाको प्रयोग बढी भएको संकेत गर्दछ, जसले यहाँको जनताको जीवनस्तरमा सकारात्मक प्रभाव पारेको छ।
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">Ward with Lowest Modern Electricity Source Usage in Khajura</span>
            </h4>
            {worstWard && (
              <div className="flex items-center gap-3">
                <div
                  className="w-4 h-16 rounded"
                  style={{
                    backgroundColor: ELECTRICITY_SOURCE_CATEGORIES.KEROSENE.color,
                  }}
                ></div>
                <div>
                  <p className="text-2xl font-bold">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    आधुनिक विद्युत स्रोत प्रयोग: {localizeNumber(worstWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
                      {worstWard.percentage.toFixed(2)}% modern electricity source usage
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 p-3 bg-red-50 rounded-lg border border-red-100">
                <p className="text-sm">
                  यस वडामा आधुनिक विद्युत स्रोतको प्रयोग न्यून छ। अधिकांश घरधुरीहरूले मट्टितेल वा परम्परागत स्रोत प्रयोग गर्ने गर्दछन्, जसले स्वास्थ्यमा नकारात्मक असर पार्नुका साथै आर्थिक र शैक्षिक विकासमा बाधा पुर्याउँछ।
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            ...
            <div className="text-center mb-4">
              ...
              <p className="mt-2 text-sm font-medium">{electricityAccessLevel} स्तर</p>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <p className="flex gap-2">
                ...
                <span>
                  <strong>सूचकाङ्क विवरण:</strong> विद्युत पहुँच सूचकाङ्क विभिन्न प्रकारका विद्युत स्रोतहरूको प्रयोग र तिनीहरूको गुणस्तरको भारित औसतमा आधारित छ।
                </span>
              </p>
              <p className="flex gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  <strong>व्याख्या:</strong> {localizeNumber((electricityAccessIndex).toFixed(1), "ne")} अंकले {electricityAccessLevel} विद्युत पहुँच दर्शाउँछ। यसमा सुधारका लागि ग्रिड विद्युत र सौर्य ऊर्जाको पहुँच र प्रयोग बढाउनुपर्ने देखिन्छ।
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div>
              <h5 className="text-sm font-medium">आधुनिक विद्युत स्रोत प्रयोग</h5>
              <div className="mt-2 space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        ...
                        style={{ backgroundColor: ELECTRICITY_SOURCE_CATEGORIES.ELECTRICITY.color }}
                      ></span>
                      {ELECTRICITY_SOURCE_CATEGORIES.ELECTRICITY.name}
                    </span>
                    <span className="font-medium">
                      {localizeNumber(sourceTypePercentages.ELECTRICITY?.toFixed(2) || "0.00", "ne")}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        className="inline-block w-2 h-2 rounded-full mr-2" 
                        style={{ backgroundColor: ELECTRICITY_SOURCE_CATEGORIES.SOLAR.color }}
                      ></span>
                      {ELECTRICITY_SOURCE_CATEGORIES.SOLAR.name}
                    </span>
                    <span className="font-medium">
                      {localizeNumber(sourceTypePercentages.SOLAR?.toFixed(2) || "0.00", "ne")}%
                    </span>
                  </div>
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: ELECTRICITY_SOURCE_CATEGORIES.SOLAR.color,
                      }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="pt-2 mt-2 border-t">
                  ...
                  <p className="text-sm mt-2 text-muted-foreground">
                    कुल {localizeNumber(modernSourceTotal.toLocaleString(), "ne")} घरधुरीले आधुनिक विद्युत स्रोत प्रयोग गर्दछन्
                  </p>
                </div>
              </div>
            </div>
