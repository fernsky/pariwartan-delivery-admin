  ...
  const generateStructuredData = () => {
    ...
    const sourceStats = wardNumbers
      .map((wardNumber) => {
        ...
        return {
          "@type": "Observation",
          name: `Electricity Source Usage Statistics in Ward ${wardNumber} of pariwartan Rural Municipality`,
          ...
          description: `In Ward ${wardNumber} of pariwartan Rural Municipality, ${modernSourceHouseholds.toLocaleString()} households (${modernSourcePercent}%) use modern electricity sources (Grid, Solar) out of a total of ${totalWardHouseholds.toLocaleString()} households.`,
        };
      })
      .filter(Boolean);
    ...
    return {
      ...
      url: "https://digital.pariwartanmun.gov.np/profile/physical/ward-wise-electricity-source",
      creator: {
        "@type": "Organization",
