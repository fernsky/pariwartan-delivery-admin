...
import TimeToMarketCenterPieChart from "./charts/time-to-market-center-pie-chart";
import TimeToMarketCenterBarChart from "./charts/time-to-market-center-bar-chart";
import TimeToMarketCenterComparisonChart from "./charts/time-to-market-center-comparison-chart";
import WardTimeToMarketCenterPieCharts from "./charts/ward-time-to-market-center-pie-charts";

interface WardWiseTimeToMarketCenterChartsProps {
  pieChartData: Array<{
    name: string;
    nameEn: string;
    value: number;
...
export default function WardWiseTimeToMarketCenterCharts({
  pieChartData,
  wardWiseData,
  totalHouseholds,
  timeCategoryTotals,
  ...
  TIME_CATEGORIES,
  accessibilityIndex,
}: WardWiseTimeToMarketCenterChartsProps) {
  return (
    <>
      ...
      >
        <meta
          itemProp="name"
          content="Time to Market Center Distribution in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content={`Distribution of time taken to reach market centers with a total of ${totalHouseholds} households`}
        />

        <div className="border-b px-4 py-3">
          <h3 className="text-xl font-semibold" itemProp="headline">
            बजार केन्द्र पुग्न लाग्ने समय अनुसार वितरण
          </h3>
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Time to Market Center in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Distribution of time to market center across wards in pariwartan"
        />

        <div className="border-b px-4 py-3">
          <h3 className="text-xl font-semibold" itemProp="headline">
            वडा अनुसार बजार केन्द्र पुग्ने समय
          </h3>
          <p className="text-sm text-muted-foreground">
            वडा अनुसार बजार केन्द्रसम्म पुग्न लाग्ने समयको वितरण
          </p>
        </div>

        <div className="p-6">
          <div className="h-[500px]">
            <TimeToMarketCenterBarChart
      ...
      >
        <meta
          itemProp="name"
          content="Quick Access to Market Center Comparison Across Wards in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Comparison of quick access to market centers across wards in pariwartan"
        />
        ...
        <div className="p-6">
          <div className="h-[400px]">
            <TimeToMarketCenterComparisonChart
      ...
      >
        <meta
          itemProp="name"
          content="Ward-wise Market Center Access Analysis in pariwartan Rural Municipality"
        />
        <meta
          itemProp="description"
          content="Detailed analysis of time to market center by ward in pariwartan"
        />

        <div className="border-b px-4 py-3">
          <h3 className="text-xl font-semibold" itemProp="headline">
            वडागत बजार केन्द्र पहुँचको विश्लेषण
          </h3>
          <p className="text-sm text-muted-foreground">
            वडा अनुसार बजार केन्द्र पुग्न लाग्ने समयको विस्तृत विश्लेषण
          </p>
        </div>
