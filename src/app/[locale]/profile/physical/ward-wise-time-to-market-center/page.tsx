...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका बजार केन्द्र पहुँच",
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality market center access",
    ...
    const descriptionEN = `Analysis of time taken to reach market centers in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${under15MinPercentage}% (${under15MinHouseholds.toLocaleString()}) can reach a market center within 15 minutes.`;
    ...
    return {
      title:
        "बजार केन्द्र पुग्न लाग्ने समयको अवस्था | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="बजार केन्द्र पुग्न लाग्ने समय - परिवर्तन गाउँपालिका (Time to Market Center - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको अवस्था
            </h1>
            ...
            <p>
              ...
              पुर्‍याउँछ। यस खण्डमा परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा बजार
            ...
            <p>
              परिवर्तन गाउँपालिकामा बजार केन्द्रसम्म पुग्न लाग्ने समयको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा बजार केन्द्र पहुँचको विश्लेषण गर्दा, समग्रमा
              {localizeNumber(
                timeCategoryPercentages.UNDER_30_MIN.toFixed(2),
                "ne",
              )}
            ...
            <p>
              परिवर्तन गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी परिवर्तन गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको
