...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality household facilities",
    ...
    const descriptionEN = `Analysis of household facilities usage in pariwartan Rural Municipality. ${mobilePercentage}% of households have mobile phones, ${televisionPercentage}% have television and ${internetPercentage}% have internet access.`;
    ...
    return {
      title:
        "घरायसी सुविधाको प्रयोगको अवस्था | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी सुविधाको प्रयोगको अवस्था - परिवर्तन गाउँपालिका (Household Facilities Usage - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा घरायसी सुविधाको प्रयोगको अवस्था
            </h1>
            ...
            <p>
              ...
              पार्दछ। यस खण्डमा परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा प्रयोग
              हुने घरायसी सुविधाहरूको विस्तृत विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              परिवर्तन गाउँपालिकामा अनुमानित कुल{" "}
              {localizeNumber(
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको विश्लेषण गर्दा,
            ...
            <p>
              परिवर्तन गाउँपालिकामा घरायसी सुविधाको प्रयोगको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी परिवर्तन गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको विश्लेषणले
