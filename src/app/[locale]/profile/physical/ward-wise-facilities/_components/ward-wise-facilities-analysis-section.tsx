...
export default function WardWiseFacilitiesAnalysisSection({
  ...
  const digitalAccessLevel = 
    ...
    digitalAccessIndex >= 50 ? "राम्रो" :
    digitalAccessIndex >= 30 ? "मध्यम" :
    "न्यून";
  ...
  return (
    <>
      ...
      >
        ...
        {["MOBILE_PHONE", "TELEVISION", "INTERNET", "COMPUTER"].map((facilityKey) => {
          const category = FACILITY_CATEGORIES[facilityKey as keyof typeof FACILITY_CATEGORIES];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            {bestDigitalWard && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(bestDigitalWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    डिजिटल पहुँच स्कोर: {localizeNumber(bestDigitalWard.score.toFixed(2), "ne")}
                    <span className="sr-only">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 space-y-2">
                <p className="text-sm">
                  यस वडामा डिजिटल सुविधाको पहुँच उच्च छ, विशेष गरी इन्टरनेट को पहुँच {localizeNumber(bestDigitalWard.internetPercentage.toFixed(2), "ne")}% र कम्प्युटरको पहुँच {localizeNumber(bestDigitalWard.computerPercentage.toFixed(2), "ne")}% रहेको छ।
                </p>
                <p className="text-sm">
                  यस वडाको डिजिटल पहुँच पालिकाको औसतभन्दा {localizeNumber((bestDigitalWard.score - digitalAccessIndex).toFixed(2), "ne")} अंकले बढी छ, जसले यहाँको सूचना प्रविधिको अवस्था राम्रो रहेको संकेत गर्दछ।
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">Ward with Lowest Digital Access in Khajura</span>
            </h4>
            {worstDigitalWard && (
              <div className="flex items-center gap-3">
                <div
                ...
                <div>
                  <p className="text-2xl font-bold">
                    वडा {localizeNumber(worstDigitalWard.wardNumber.toString(), "ne")}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    डिजिटल पहुँच स्कोर: {localizeNumber(worstDigitalWard.score.toFixed(2), "ne")}
                    <span className="sr-only">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 p-3 bg-red-50 rounded-lg border border-red-100">
                <p className="text-sm">
                  यस वडामा डिजिटल सुविधाहरूको पहुँच न्यून छ, विशेष गरी इन्टरनेट को पहुँच {localizeNumber(worstDigitalWard.internetPercentage.toFixed(2), "ne")}% र कम्प्युटरको पहुँच {localizeNumber(worstDigitalWard.computerPercentage.toFixed(2), "ne")}% मात्र रहेको छ।
                </p>
                <p className="text-sm mt-2">
                  यस वडामा डिजिटल पहुँच विस्तार गर्न प्राथमिकता दिनुपर्ने देखिन्छ, जसले यहाँको शिक्षा, रोजगारी र सेवा पहुँचमा सुधार ल्याउन मद्दत गर्न सक्छ।
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            ...
            <div className="text-center mb-4">
              ...
              <p className="mt-2 text-sm font-medium">{digitalAccessLevel} स्तर</p>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <p className="flex gap-2">
                ...
                <span>
                  <strong>सूचकाङ्क विवरण:</strong> डिजिटल पहुँच सूचकाङ्क इन्टरनेट, कम्प्युटर, मोबाइल फोन र टेलिभिजन जस्ता डिजिटल सुविधाहरूको पहुँचको भारित औसतमा आधारित छ।
                </span>
              </p>
              <p className="flex gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  <strong>व्याख्या:</strong> {localizeNumber((digitalAccessIndex).toFixed(1), "ne")} अंकले {digitalAccessLevel} डिजिटल पहुँच दर्शाउँछ। यसमा सुधारका लागि इन्टरनेट र कम्प्युटरको पहुँच बढाउनुपर्ने देखिन्छ।
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div>
              <h5 className="text-sm font-medium">अत्यावश्यक सुविधाहरूको प्रयोग</h5>
              <div className="mt-2 space-y-3">
                <div>
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {localizeNumber(facilityTypePercentages.MOBILE_PHONE?.toFixed(2) || "0.00", "ne")}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {localizeNumber(facilityTypePercentages.INTERNET?.toFixed(2) || "0.00", "ne")}%
                    </span>
                  </div>
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                ...
                <div className="pt-2 mt-2 border-t">
                  <div className="flex justify-between text-sm font-medium">
                    ...
                    <span>
                      {localizeNumber(categoryStats.digital.percentage.toFixed(2), "ne")}%
                    </span>
                  </div>
                  <p className="text-sm mt-2 text-muted-foreground">
                    कुल {localizeNumber(categoryStats.digital.total.toLocaleString(), "ne")} घरधुरीमा डिजिटल सुविधाको पहुँच रहेको अनुमान
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="bg-card p-4 rounded border">
            ...
            <div className="text-3xl font-bold mb-2">
              {localizeNumber(categoryStats.communication.percentage.toFixed(1), "ne")}%
            </div>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div className="text-3xl font-bold mb-2">
              {localizeNumber(categoryStats.transportation.percentage.toFixed(1), "ne")}%
            </div>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div className="text-3xl font-bold mb-2">
              {localizeNumber(categoryStats.appliances.percentage.toFixed(1), "ne")}%
            </div>
            <p className="text-sm text-muted-foreground">
