...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका सार्वजनिक यातायात पहुँच",
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality public transport access",
    ...
    const descriptionEN = `Analysis of time taken to reach public transportation in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${under15MinPercentage}% (${under15MinHouseholds.toLocaleString()}) can reach public transport within 15 minutes.`;
    ...
    return {
      title:
        "सार्वजनिक यातायात पुग्न लाग्ने समयको अवस्था | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="सार्वजनिक यातायात पुग्न लाग्ने समय - परिवर्तन गाउँपालिका (Time to Public Transport - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको अवस्था
            </h1>
            ...
            <p>
              ...
              अवस्था बुझ्न मद्दत पुर्‍याउँछ। यस खण्डमा परिवर्तन गाउँपालिकाको
            ...
            <p>
              परिवर्तन गाउँपालिकामा सार्वजनिक यातायातसम्म पुग्न लाग्ने समयको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा सार्वजनिक यातायात पहुँचको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                timeCategoryPercentages.UNDER_30_MIN.toFixed(2),
                "ne",
            ...
            <p>
              परिवर्तन गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको
            ...
            <p className="mt-6">
              यसरी परिवर्तन गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको
