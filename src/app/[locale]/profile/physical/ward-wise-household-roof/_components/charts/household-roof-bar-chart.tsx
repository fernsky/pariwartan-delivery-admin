...
interface HouseholdRoofBarChartProps {
...
export default function HouseholdRoofBarChart({
  wardWiseData,
  ROOF_CATEGORIES,
}: HouseholdRoofBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(ROOF_CATEGORIES).map((category, index, arr) => (
          <Bar
            key={category.name}
