...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "परिवर्तन गाउँपालिका खाना पकाउने इन्धन",
    ...
    const keywordsEN = [
      "pariwartan Rural Municipality cooking fuel",
    ...
    const descriptionEN = `Analysis of cooking fuel usage in pariwartan Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${cleanFuelPercentage}% use clean fuels (LP Gas, Electricity, Biogas).`;
    ...
    return {
      title:
        "खाना पकाउने इन्धनको प्रयोगको अवस्था | परिवर्तन गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खाना पकाउने इन्धनको प्रयोगको अवस्था - परिवर्तन गाउँपालिका (Cooking Fuel Usage - pariwartan Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              परिवर्तन गाउँपालिकामा खाना पकाउने इन्धनको प्रयोगको अवस्था
            </h1>
            ...
            <p>
              ...
              परिवर्तन गाउँपालिकाको विभिन्न वडाहरूमा प्रयोग हुने खाना पकाउने
            ...
            <p>
              परिवर्तन गाउँपालिकामा खाना पकाउने इन्धनको प्रयोगको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              परिवर्तन गाउँपालिकामा खाना पकाउने इन्धनको प्रयोगको विश्लेषण गर्दा,
              समग्रमा
            ...
            <p>
              परिवर्तन गाउँपालिकामा खाना पकाउने इन्धनको प्रयोगको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी परिवर्तन गाउँपालिकामा खाना पकाउने इन्धनको प्रयोगको विश्लेषणले
