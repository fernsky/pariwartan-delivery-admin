...
export default function WardWiseCookingFuelAnalysisSection({
  ...
  const cleanFuelLevel = 
    cleanFuelIndex >= 75 ? "उच्च" :
    cleanFuelIndex >= 50 ? "राम्रो" :
    cleanFuelIndex >= 30 ? "मध्यम" :
    "न्यून";
  ...
  const traditionalFuelPercentage = ((traditionalFuelTotal / totalHouseholds) * 100).toFixed(2);
  ...
  return (
    <>
      ...
      >
        ...
        {Object.entries(COOKING_FUEL_CATEGORIES).map(([categoryKey, category]) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    स्वच्छ इन्धन प्रयोग: {localizeNumber(bestWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 space-y-2">
                <p className="text-sm">
                  यस वडामा स्वच्छ इन्धन (एल.पी. ग्याँस, विद्युत, गोबर ग्याँस) को प्रयोग उच्च छ, जुन पालिकाको औसतभन्दा {localizeNumber((bestWard.percentage - cleanFuelPercentage).toFixed(2), "ne")}% ले बढी छ।
                </p>
                <p className="text-sm">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">Ward with Lowest Clean Fuel Usage in Khajura</span>
            </h4>
            {worstWard && (
              <div className="flex items-center gap-3">
                <div
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    स्वच्छ इन्धन प्रयोग: {localizeNumber(worstWard.percentage.toFixed(2), "ne")}%
                    <span className="sr-only">
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div className="space-y-3 text-sm">
              <p className="flex gap-2">
                ...
                <span>
                  <strong>सूचकाङ्क विवरण:</strong> स्वच्छ इन्धन सूचकाङ्क विभिन्न इन्धन प्रकारहरूको प्रयोग र तिनीहरूको वातावरणीय प्रभावको भारित औसतमा आधारित छ।
                </span>
              </p>
              <p className="flex gap-2">
                <span className="text-green-500">•</span>
                <span>
                  <strong>व्याख्या:</strong> {localizeNumber((cleanFuelIndex).toFixed(1), "ne")} अंकले {cleanFuelLevel} स्वच्छ इन्धन प्रयोग दर्शाउँछ। यसमा सुधारका लागि एल.पी. ग्याँस र विद्युतको पहुँच र प्रयोग बढाउनुपर्ने देखिन्छ।
                </span>
              </p>
            </div>
          </div>
              ...
              <div className="mt-2 space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        ...
                        style={{ backgroundColor: COOKING_FUEL_CATEGORIES.LP_GAS.color }}
                      ></span>
                      {COOKING_FUEL_CATEGORIES.LP_GAS.name}
                    </span>
                    <span className="font-medium">
                      {localizeNumber(fuelTypePercentages.LP_GAS?.toFixed(2) || "0.00", "ne")}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm">
                    <span>
                      <span 
                        className="inline-block w-2 h-2 rounded-full mr-2" 
                        style={{ backgroundColor: COOKING_FUEL_CATEGORIES.ELECTRICITY.color }}
                      ></span>
                      {COOKING_FUEL_CATEGORIES.ELECTRICITY.name}
                    </span>
                    <span className="font-medium">
                      {localizeNumber(fuelTypePercentages.ELECTRICITY?.toFixed(2) || "0.00", "ne")}%
                    </span>
                  </div>
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: COOKING_FUEL_CATEGORIES.ELECTRICITY.color,
                      }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="pt-2 mt-2 border-t">
                  ...
                  <p className="text-sm mt-2 text-muted-foreground">
                    कुल {localizeNumber(cleanFuelTotal.toLocaleString(), "ne")} घरधुरीले स्वच्छ इन्धन प्रयोग गर्दछन्
                  </p>
                </div>
              </div>
            </div>
