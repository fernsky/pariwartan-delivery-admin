...
import { Shield, Lock, Eye, FileText, UserCheck, BookOpen, CheckCircle2, ChevronRight, Settings, Bell } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import Image from "next/image";

export const metadata: Metadata = {
  title: "गोपनीयता नीति | खजुरा गाउँपालिका",
  description: "खजुरा गाउँपालिका डिजिटल प्रोफाइलको गोपनीयता नीति",
};
        ...
        <div className="bg-gradient-to-r from-[#0b1f42] to-[#1a4894] py-16 md:py-24">
          ...
          <div className="container px-4 sm:px-6 max-w-5xl mx-auto relative z-10">
            ...
            <p className="text-white/90 text-lg max-w-3xl">
              खजुरा गाउँपालिकाको डिजिटल प्रोफाइलमा तपाईंको गोपनीयता हाम्रो
      ...
      <div className="container px-4 sm:px-6 max-w-5xl mx-auto py-12">
        <div className="mb-8 bg-gradient-to-r from-[#0b1f42]/5 to-[#1a4894]/5 rounded-xl p-6">
          ...
          <p className="text-gray-700">
            खजुरा गाउँपालिकाको डिजिटल प्रोफाइल प्रयोग गरेर, तपाईंले यस गोपनीयता
            नीति अन्तर्गत आफ्नो जानकारी संकलन र प्रशोधन गर्न सहमति दिनुहुन्छ। यो
            नीति समय-समयमा परिमार्जन हुन सक्छ, त्यसैले कृपया नियमित रूपमा यसलाई
            हेर्नुहोला।
          </p>
        </div>
        ...
        <div className="mt-12 bg-white p-6 rounded-xl border border-[#123772]/10 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <p className="text-gray-700">
                यो गोपनीयता नीति खजुरा गाउँपालिकाको डिजिटल प्रोफाइल वेबसाइटमा
