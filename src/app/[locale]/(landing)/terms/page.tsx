...
import { FileText, ScrollText, AlertCircle, GanttChart, Scale, FileWarning, Info, MessageSquare, Bell } from "lucide-react";
...
export const metadata: Metadata = {
  title: "नियम र शर्तहरू | खजुरा गाउँपालिका",
  description: "खजुरा गाउँपालिका डिजिटल प्रोफाइल प्रयोगका नियम र शर्तहरू",
};
  ...
  const termsSections = [
    {
      ...
      content: [
        "खजुरा गाउँपालिकाको डिजिटल प्रोफाइल वेबसाइट प्रयोग गर्दा निम्न नियमहरू लागू हुनेछन्:",
    ...
    },
    {
      ...
      content: [
        ...
        "• लोगो, चित्र, ग्राफिक, लेआउट र डिजाइन खजुरा गाउँपालिकाको स्वामित्वमा छन्",
    ...
    },
    {
      ...
      content: [
        "खजुरा गाउँपालिका निम्न अवस्थाहरूमा जवाफदेही हुने छैन:",
    ...
    },
    {
      ...
      content: [
        "खजुरा गाउँपालिकाले यी नियम र शर्तहरू परिवर्तन गर्ने अधिकार राख्दछ:",
        ...
        <div className="bg-gradient-to-r from-[#0b1f42] to-[#1a4894] py-16 md:py-24">
          ...
          <div className="container px-4 sm:px-6 max-w-5xl mx-auto relative z-10">
            ...
            <p className="text-white/90 text-lg max-w-3xl">
              खजुरा गाउँपालिकाको डिजिटल प्रोफाइल सेवा प्रयोग गर्नु अघि कृपया यी नियम र शर्तहरू ध्यानपूर्वक पढ्नुहोस्। यी शर्तहरू स्वीकार गरेपछि मात्र वेबसाइट प्रयोग गर्नु उपयुक्त हुनेछ।
            </p>
          </div>
        </div>
      ...
      <div className="container px-4 sm:px-6 max-w-5xl mx-auto py-12">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1 space-y-4">
              ...
              <p className="text-gray-700">
                यस वेबसाइट प्रयोग गरेर, तपाईंले यी सम्पूर्ण नियम र शर्तहरू पढेर बुझेको मानिनेछ। यदि तपाईं यी शर्तहरू स्वीकार गर्न चाहनुहुन्न भने, यस वेबसाइटको प्रयोगबाट तुरुन्तै रोक्नुहोस्। यस वेबसाइटका सबै सुविधा र सामग्रीहरू यी शर्तहरूको अधीनमा रहेर प्रदान गरिन्छन्।
              </p>

              <p className="text-[#123772] font-medium">
                यो दस्तावेज कानूनी रूपमा बाध्यकारी सम्झौता हो जसले खजुरा गाउँपालिका र प्रयोगकर्ताबीचको सम्बन्धलाई परिभाषित गर्दछ।
              </p>
            </div>
        ...
        <div className="space-y-6">
          {termsSections.map((section, index) => (
            <Card key={index} className="overflow-hidden shadow-sm hover:shadow-md transition-all border border-[#123772]/10">
              <CardHeader className="bg-gradient-to-r from-[#0b1f42]/5 to-[#1a4894]/5 border-b border-[#123772]/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg text-[#0b1f42]">{section.title}</CardTitle>
                    <CardDescription className="text-[#123772]/70">{section.description}</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="space-y-4">
                  {section.content.map((paragraph, i) => (
                    <p key={i} className={i === 0 ? "font-medium text-[#123772]" : "text-gray-600"}>
                      {paragraph}
                    </p>
                  ))}
                </div>
        ...
        <div className="mt-12 bg-white p-6 rounded-xl border border-[#123772]/10 shadow-sm">
          ...
          <p className="text-gray-700 mb-4">
            यी नियम र शर्तहरूको बारेमा कुनै प्रश्न, स्पष्टीकरण वा सुझाव भएमा, कृपया हामीलाई निम्न माध्यमबाट सम्पर्क गर्न सक्नुहुनेछ:
          </p>
          
          <div className="grid md:grid-cols-2 gap-6 mt-4">
            <div className="p-4 bg-[#123772]/5 rounded-lg">
              <h3 className="font-medium text-[#0b1f42] mb-2">कार्यालय ठेगाना</h3>
              <p className="text-gray-700">
                खजुरा गाउँपालिका कार्यालय<br />
                बाँके, लुम्बिनी प्रदेश<br />
                नेपाल
              </p>
            </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center sm:justify-end">
            <Link href="/privacy" passHref>
              <Button variant="outline" className="border-[#123772]/20 text-[#123772] hover:bg-[#123772]/5">
