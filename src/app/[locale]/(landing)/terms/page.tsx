...
export const metadata: Metadata = {
  title: "नियम र शर्तहरू | परिवर्तन गाउँपालिका",
  description: "परिवर्तन गाउँपालिका डिजिटल प्रोफाइल प्रयोगका नियम र शर्तहरू",
};
  ...
  const termsSections = [
    {
      ...
      content: [
        "परिवर्तन गाउँपालिकाको डिजिटल प्रोफाइल वेबसाइट प्रयोग गर्दा निम्न नियमहरू लागू हुनेछन्:",
    ...
    },
    {
      ...
      content: [
        ...
        "• लोगो, चित्र, ग्राफिक, लेआउट र डिजाइन परिवर्तन गाउँपालिकाको स्वामित्वमा छन्",
    ...
    },
    {
      ...
      content: [
        "परिवर्तन गाउँपालिका निम्न अवस्थाहरूमा जवाफदेही हुने छैन:",
    ...
    },
    {
      ...
      content: [
        "परिवर्तन गाउँपालिकाले यी नियम र शर्तहरू परिवर्तन गर्ने अधिकार राख्दछ:",
        ...
        <div className="bg-gradient-to-r from-[#0b1f42] to-[#1a4894] py-16 md:py-24">
          ...
          <div className="container px-4 sm:px-6 max-w-5xl mx-auto relative z-10">
            ...
            <p className="text-white/90 text-lg max-w-3xl">
              परिवर्तन गाउँपालिकाको डिजिटल प्रोफाइल सेवा प्रयोग गर्नु अघि कृपया
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1 space-y-4">
              ...
              <p className="text-[#123772] font-medium">
                यो दस्तावेज कानूनी रूपमा बाध्यकारी सम्झौता हो जसले परिवर्तन
        ...
        <div className="mt-12 bg-white p-6 rounded-xl border border-[#123772]/10 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-4">
            <div className="p-4 bg-[#123772]/5 rounded-lg">
              ...
              <p className="text-gray-700">
                परिवर्तन गाउँपालिका कार्यालय
                <br />
                बाँके, लुम्बिनी प्रदेश
                <br />
                नेपाल
              </p>
            </div>
